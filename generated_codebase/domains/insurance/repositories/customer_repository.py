...
@dataclass
class InsuranceCustomerEntity:
    """Entity for insurance customer"""
    id: str
    data: Dict[str, Any]
...
class InsuranceCustomerInMemoryRepository(BaseInsuranceRepository[InsuranceCustomerEntity]):
    """In-memory repository for insurance customer"""

    def __init__(self):
        self._storage: Dict[str, InsuranceCustomerEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: InsuranceCustomerEntity) -> InsuranceCustomerEntity:
    ...
    async def read(self, id: str) -> Optional[InsuranceCustomerEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: InsuranceCustomerEntity) -> InsuranceCustomerEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[InsuranceCustomerEntity]:
    ...
    async def find_by(self, **kwargs) -> List[InsuranceCustomerEntity]:
...
class InsuranceCustomerCachedRepository(BaseInsuranceRepository[InsuranceCustomerEntity]):
    """Cached repository wrapper for insurance customer"""
...
class InsuranceCustomerUnitOfWork:
    """Unit of Work pattern for insurance customer"""

    def __init__(self, repository: BaseInsuranceRepository):
        self._repository = repository
        self._new: List[InsuranceCustomerEntity] = []
        self._dirty: List[InsuranceCustomerEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: InsuranceCustomerEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: InsuranceCustomerEntity) -> None:
