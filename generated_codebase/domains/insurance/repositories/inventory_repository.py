"""
Insurance Inventory Repository
...
@dataclass
class InsuranceInventoryEntity:
    """Entity for insurance inventory"""
    id: str
    data: Dict[str, Any]
...
class InsuranceInventoryInMemoryRepository(BaseInsuranceRepository[InsuranceInventoryEntity]):
    """In-memory repository for insurance inventory"""

    def __init__(self):
        self._storage: Dict[str, InsuranceInventoryEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: InsuranceInventoryEntity) -> InsuranceInventoryEntity:
    ...
    async def read(self, id: str) -> Optional[InsuranceInventoryEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: InsuranceInventoryEntity) -> InsuranceInventoryEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[InsuranceInventoryEntity]:
    ...
    async def find_by(self, **kwargs) -> List[InsuranceInventoryEntity]:
...
class InsuranceInventoryCachedRepository(BaseInsuranceRepository[InsuranceInventoryEntity]):
    """Cached repository wrapper for insurance inventory"""
...
class InsuranceInventoryUnitOfWork:
    """Unit of Work pattern for insurance inventory"""

    def __init__(self, repository: BaseInsuranceRepository):
        self._repository = repository
        self._new: List[InsuranceInventoryEntity] = []
        self._dirty: List[InsuranceInventoryEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: InsuranceInventoryEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: InsuranceInventoryEntity) -> None:
