...
@dataclass
class InsuranceSupplierEntity:
    """Entity for insurance supplier"""
    id: str
    data: Dict[str, Any]
...
class InsuranceSupplierInMemoryRepository(BaseInsuranceRepository[InsuranceSupplierEntity]):
    """In-memory repository for insurance supplier"""

    def __init__(self):
        self._storage: Dict[str, InsuranceSupplierEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: InsuranceSupplierEntity) -> InsuranceSupplierEntity:
    ...
    async def read(self, id: str) -> Optional[InsuranceSupplierEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: InsuranceSupplierEntity) -> InsuranceSupplierEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[InsuranceSupplierEntity]:
    ...
    async def find_by(self, **kwargs) -> List[InsuranceSupplierEntity]:
...
class InsuranceSupplierCachedRepository(BaseInsuranceRepository[InsuranceSupplierEntity]):
    """Cached repository wrapper for insurance supplier"""
...
class InsuranceSupplierUnitOfWork:
    """Unit of Work pattern for insurance supplier"""

    def __init__(self, repository: BaseInsuranceRepository):
        self._repository = repository
        self._new: List[InsuranceSupplierEntity] = []
        self._dirty: List[InsuranceSupplierEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: InsuranceSupplierEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: InsuranceSupplierEntity) -> None:
