...
@dataclass
class InsuranceEmployeeEntity:
    """Entity for insurance employee"""
    id: str
    data: Dict[str, Any]
...
class InsuranceEmployeeInMemoryRepository(BaseInsuranceRepository[InsuranceEmployeeEntity]):
    """In-memory repository for insurance employee"""

    def __init__(self):
        self._storage: Dict[str, InsuranceEmployeeEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: InsuranceEmployeeEntity) -> InsuranceEmployeeEntity:
    ...
    async def read(self, id: str) -> Optional[InsuranceEmployeeEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: InsuranceEmployeeEntity) -> InsuranceEmployeeEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[InsuranceEmployeeEntity]:
    ...
    async def find_by(self, **kwargs) -> List[InsuranceEmployeeEntity]:
...
class InsuranceEmployeeCachedRepository(BaseInsuranceRepository[InsuranceEmployeeEntity]):
    """Cached repository wrapper for insurance employee"""
...
class InsuranceEmployeeUnitOfWork:
    """Unit of Work pattern for insurance employee"""

    def __init__(self, repository: BaseInsuranceRepository):
        self._repository = repository
        self._new: List[InsuranceEmployeeEntity] = []
        self._dirty: List[InsuranceEmployeeEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: InsuranceEmployeeEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: InsuranceEmployeeEntity) -> None:
