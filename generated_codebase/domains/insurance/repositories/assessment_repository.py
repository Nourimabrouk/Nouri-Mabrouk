...
@dataclass
class InsuranceAssessmentEntity:
    """Entity for insurance assessment"""
    id: str
    data: Dict[str, Any]
...
class InsuranceAssessmentInMemoryRepository(BaseInsuranceRepository[InsuranceAssessmentEntity]):
    """In-memory repository for insurance assessment"""

    def __init__(self):
        self._storage: Dict[str, InsuranceAssessmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: InsuranceAssessmentEntity) -> InsuranceAssessmentEntity:
    ...
    async def read(self, id: str) -> Optional[InsuranceAssessmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: InsuranceAssessmentEntity) -> InsuranceAssessmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[InsuranceAssessmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[InsuranceAssessmentEntity]:
...
class InsuranceAssessmentCachedRepository(BaseInsuranceRepository[InsuranceAssessmentEntity]):
    """Cached repository wrapper for insurance assessment"""
...
class InsuranceAssessmentUnitOfWork:
    """Unit of Work pattern for insurance assessment"""

    def __init__(self, repository: BaseInsuranceRepository):
        self._repository = repository
        self._new: List[InsuranceAssessmentEntity] = []
        self._dirty: List[InsuranceAssessmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: InsuranceAssessmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: InsuranceAssessmentEntity) -> None:
