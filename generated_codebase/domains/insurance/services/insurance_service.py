...
class BaseInsuranceService(ABC):
    """Base service class for insurance"""
...
class InsuranceAPIService(BaseInsuranceService):
    """REST API service for insurance"""
...
class InsuranceGRPCService(BaseInsuranceService):
    """gRPC service for insurance"""
...
class InsuranceWebSocketService(BaseInsuranceService):
    """WebSocket service for insurance"""
...
class InsuranceEventService(BaseInsuranceService):
    """Event-driven service for insurance"""
...
class InsuranceServiceRegistry:
    """Service registry for insurance"""

    _services: Dict[str, BaseInsuranceService] = {}

    @classmethod
    def register(cls, name: str, service: BaseInsuranceService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseInsuranceService]:
