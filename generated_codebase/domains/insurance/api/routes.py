...
# Route definitions for insurance domain
ROUTES = {
    "base_path": "/api/v1/insurance",
    "endpoints": [
        {
            "path": "/",
            "method": "GET",
            "handler": "list_insurance",
            "description": "List all insurance resources",
            "auth_required": True,
            "rate_limit": 100
        },
        {
        ...
        },
        {
            "path": "/{id}",
            "method": "GET",
            "handler": "get_insurance",
            "description": "Get insurance resource by ID",
            "auth_required": True,
            "rate_limit": 200
        },
        {
        ...
        },
        {
            "path": "/search",
            "method": "POST",
            "handler": "search_insurance",
            "description": "Search insurance resources",
            "auth_required": True,
            "rate_limit": 100
        },
        {
            "path": "/bulk",
            "method": "POST",
            "handler": "bulk_create_insurance",
            "description": "Bulk create insurance resources",
            "auth_required": True,
            "rate_limit": 10
        },
        {
            "path": "/export",
            "method": "GET",
            "handler": "export_insurance",
            "description": "Export insurance data",
            "auth_required": True,
            "rate_limit": 5
        },
        {
            "path": "/import",
            "method": "POST",
            "handler": "import_insurance",
            "description": "Import insurance data",
            "auth_required": True,
            "rate_limit": 5
        },
        {
            "path": "/stats",
            "method": "GET",
            "handler": "get_insurance_stats",
            "description": "Get insurance statistics",
            "auth_required": True,
            "rate_limit": 50
        }
    ]
...
class InsuranceRouteHandler:
    """Route handler for insurance"""
    ...
    async def list_insurance(self, params: Dict[str, Any]) -> RouteResponse:
        """List insurance resources"""
        try:
            ...
            return RouteResponse(
                ...
                metadata={"endpoint": "list_insurance"}
            )
        except Exception as e:
            logger.error(f"Error listing insurance: {e}")
            return RouteResponse(success=False, error=str(e))

    async def create_insurance(self, data: Dict[str, Any]) -> RouteResponse:
        """Create insurance resource"""
        try:
            # Validate and create
            ...
            return RouteResponse(
                success=True,
                data=result,
                metadata={"endpoint": "create_insurance"}
            )
        except Exception as e:
            logger.error(f"Error creating insurance: {e}")
            return RouteResponse(success=False, error=str(e))

    async def get_insurance(self, id: str) -> RouteResponse:
        """Get insurance resource by ID"""
        try:
            # result = await self.repository.read(id)
            result = {"id": id, "name": f"insurance_{id}"}
            ...
            logger.error(f"Error getting insurance {id}: {e}")
            return RouteResponse(success=False, error=str(e))

    async def update_insurance(self, id: str, data: Dict[str, Any]) -> RouteResponse:
        """Update insurance resource"""
        try:
            ...
            return RouteResponse(
                success=True,
                data=result,
                metadata={"endpoint": "update_insurance"}
            )
        except Exception as e:
            logger.error(f"Error updating insurance {id}: {e}")
            return RouteResponse(success=False, error=str(e))

    async def delete_insurance(self, id: str) -> RouteResponse:
        """Delete insurance resource"""
        try:
            ...
            logger.error(f"Error deleting insurance {id}: {e}")
            return RouteResponse(success=False, error=str(e))

    async def search_insurance(self, query: Dict[str, Any]) -> RouteResponse:
        """Search insurance resources"""
        try:
            ...
            logger.error(f"Error searching insurance: {e}")
            return RouteResponse(success=False, error=str(e))

    async def bulk_create_insurance(self, items: List[Dict[str, Any]]) -> RouteResponse:
        """Bulk create insurance resources"""
        try:
            created = []
            errors = []
            ...
            logger.error(f"Error bulk creating insurance: {e}")
            return RouteResponse(success=False, error=str(e))

    async def export_insurance(self, params: Dict[str, Any]) -> RouteResponse:
        ...
        try:
            ...
            logger.error(f"Error exporting insurance: {e}")
            return RouteResponse(success=False, error=str(e))

    async def import_insurance(self, data: Dict[str, Any]) -> RouteResponse:
        ...
        try:
            ...
            logger.error(f"Error importing insurance: {e}")
            return RouteResponse(success=False, error=str(e))

    async def get_insurance_stats(self, params: Dict[str, Any] = None) -> RouteResponse:
        ...
        try:
            ...
            logger.error(f"Error getting insurance stats: {e}")
            return RouteResponse(success=False, error=str(e))


class InsuranceRouter:
    """Router for insurance endpoints"""

    def __init__(self):
        self.handler = InsuranceRouteHandler()
        self.routes = ROUTES
        self._middleware = []
    ...
    def get_openapi_spec(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "info": {
                "title": "Insurance API",
                "version": "1.0.0",
                "description": "API for insurance domain"
            },
            "paths": paths,
            "components": {
                "securitySchemes": {
