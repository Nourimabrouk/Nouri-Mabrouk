...
class BaseLegalService(ABC):
    """Base service class for legal"""
...
class LegalAPIService(BaseLegalService):
    """REST API service for legal"""
...
class LegalGRPCService(BaseLegalService):
    """gRPC service for legal"""
...
class LegalWebSocketService(BaseLegalService):
    """WebSocket service for legal"""
...
class LegalEventService(BaseLegalService):
    """Event-driven service for legal"""
...
class LegalServiceRegistry:
    """Service registry for legal"""

    _services: Dict[str, BaseLegalService] = {}

    @classmethod
    def register(cls, name: str, service: BaseLegalService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseLegalService]:
