...
class BaseLogisticsService(ABC):
    """Base service class for logistics"""
...
class LogisticsAPIService(BaseLogisticsService):
    """REST API service for logistics"""
...
class LogisticsGRPCService(BaseLogisticsService):
    """gRPC service for logistics"""
...
class LogisticsWebSocketService(BaseLogisticsService):
    """WebSocket service for logistics"""
...
class LogisticsEventService(BaseLogisticsService):
    """Event-driven service for logistics"""
...
class LogisticsServiceRegistry:
    """Service registry for logistics"""

    _services: Dict[str, BaseLogisticsService] = {}

    @classmethod
    def register(cls, name: str, service: BaseLogisticsService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseLogisticsService]:
