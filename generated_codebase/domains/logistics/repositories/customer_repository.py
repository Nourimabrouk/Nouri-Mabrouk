...
@dataclass
class LogisticsCustomerEntity:
    """Entity for logistics customer"""
    id: str
    data: Dict[str, Any]
...
class LogisticsCustomerInMemoryRepository(BaseLogisticsRepository[LogisticsCustomerEntity]):
    """In-memory repository for logistics customer"""

    def __init__(self):
        self._storage: Dict[str, LogisticsCustomerEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: LogisticsCustomerEntity) -> LogisticsCustomerEntity:
    ...
    async def read(self, id: str) -> Optional[LogisticsCustomerEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: LogisticsCustomerEntity) -> LogisticsCustomerEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[LogisticsCustomerEntity]:
    ...
    async def find_by(self, **kwargs) -> List[LogisticsCustomerEntity]:
...
class LogisticsCustomerCachedRepository(BaseLogisticsRepository[LogisticsCustomerEntity]):
    """Cached repository wrapper for logistics customer"""
...
class LogisticsCustomerUnitOfWork:
    """Unit of Work pattern for logistics customer"""

    def __init__(self, repository: BaseLogisticsRepository):
        self._repository = repository
        self._new: List[LogisticsCustomerEntity] = []
        self._dirty: List[LogisticsCustomerEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: LogisticsCustomerEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: LogisticsCustomerEntity) -> None:
