...
class BaseBiotechService(ABC):
    """Base service class for biotech"""
...
class BiotechAPIService(BaseBiotechService):
    """REST API service for biotech"""
...
class BiotechGRPCService(BaseBiotechService):
    """gRPC service for biotech"""
...
class BiotechWebSocketService(BaseBiotechService):
    """WebSocket service for biotech"""
...
class BiotechEventService(BaseBiotechService):
    """Event-driven service for biotech"""
...
class BiotechServiceRegistry:
    """Service registry for biotech"""

    _services: Dict[str, BaseBiotechService] = {}

    @classmethod
    def register(cls, name: str, service: BaseBiotechService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseBiotechService]:
