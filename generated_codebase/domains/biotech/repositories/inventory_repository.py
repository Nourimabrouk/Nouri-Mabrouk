...
@dataclass
class BiotechInventoryEntity:
    """Entity for biotech inventory"""
    id: str
    data: Dict[str, Any]
...
class BiotechInventoryInMemoryRepository(BaseBiotechRepository[BiotechInventoryEntity]):
    """In-memory repository for biotech inventory"""

    def __init__(self):
        self._storage: Dict[str, BiotechInventoryEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: BiotechInventoryEntity) -> BiotechInventoryEntity:
    ...
    async def read(self, id: str) -> Optional[BiotechInventoryEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: BiotechInventoryEntity) -> BiotechInventoryEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[BiotechInventoryEntity]:
    ...
    async def find_by(self, **kwargs) -> List[BiotechInventoryEntity]:
...
class BiotechInventoryCachedRepository(BaseBiotechRepository[BiotechInventoryEntity]):
    """Cached repository wrapper for biotech inventory"""
...
class BiotechInventoryUnitOfWork:
    """Unit of Work pattern for biotech inventory"""

    def __init__(self, repository: BaseBiotechRepository):
        self._repository = repository
        self._new: List[BiotechInventoryEntity] = []
        self._dirty: List[BiotechInventoryEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: BiotechInventoryEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: BiotechInventoryEntity) -> None:
