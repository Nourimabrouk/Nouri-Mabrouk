"""
Biotech Appointment Repository
...
@dataclass
class BiotechAppointmentEntity:
    """Entity for biotech appointment"""
    id: str
    data: Dict[str, Any]
...
class BiotechAppointmentInMemoryRepository(BaseBiotechRepository[BiotechAppointmentEntity]):
    """In-memory repository for biotech appointment"""

    def __init__(self):
        self._storage: Dict[str, BiotechAppointmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: BiotechAppointmentEntity) -> BiotechAppointmentEntity:
    ...
    async def read(self, id: str) -> Optional[BiotechAppointmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: BiotechAppointmentEntity) -> BiotechAppointmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[BiotechAppointmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[BiotechAppointmentEntity]:
...
class BiotechAppointmentCachedRepository(BaseBiotechRepository[BiotechAppointmentEntity]):
    """Cached repository wrapper for biotech appointment"""
...
class BiotechAppointmentUnitOfWork:
    """Unit of Work pattern for biotech appointment"""

    def __init__(self, repository: BaseBiotechRepository):
        self._repository = repository
        self._new: List[BiotechAppointmentEntity] = []
        self._dirty: List[BiotechAppointmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: BiotechAppointmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: BiotechAppointmentEntity) -> None:
