...
class ServiceConfig:
    ...
    name: str = "manufacturing_service"
    version: str = "1.0.0"
    host: str = "0.0.0.0"
    port: int = 8000 + 4
    workers: int = 4
...
class BaseManufacturingService(ABC):
    """Base service class for manufacturing"""
...
class ManufacturingAPIService(BaseManufacturingService):
    """REST API service for manufacturing"""
...
class ManufacturingGRPCService(BaseManufacturingService):
    """gRPC service for manufacturing"""
...
class ManufacturingWebSocketService(BaseManufacturingService):
    """WebSocket service for manufacturing"""
...
class ManufacturingEventService(BaseManufacturingService):
    """Event-driven service for manufacturing"""
...
class ManufacturingServiceRegistry:
    """Service registry for manufacturing"""

    _services: Dict[str, BaseManufacturingService] = {}

    @classmethod
    def register(cls, name: str, service: BaseManufacturingService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseManufacturingService]:
