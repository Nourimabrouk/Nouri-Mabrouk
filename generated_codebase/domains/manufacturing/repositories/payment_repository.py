"""
Manufacturing Payment Repository
...
@dataclass
class ManufacturingPaymentEntity:
    """Entity for manufacturing payment"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingPaymentInMemoryRepository(BaseManufacturingRepository[ManufacturingPaymentEntity]):
    """In-memory repository for manufacturing payment"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingPaymentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingPaymentEntity) -> ManufacturingPaymentEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingPaymentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingPaymentEntity) -> ManufacturingPaymentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingPaymentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingPaymentEntity]:
...
class ManufacturingPaymentCachedRepository(BaseManufacturingRepository[ManufacturingPaymentEntity]):
    """Cached repository wrapper for manufacturing payment"""
...
class ManufacturingPaymentUnitOfWork:
    """Unit of Work pattern for manufacturing payment"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingPaymentEntity] = []
        self._dirty: List[ManufacturingPaymentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingPaymentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingPaymentEntity) -> None:
