"""
Manufacturing Inventory Repository
...
@dataclass
class ManufacturingInventoryEntity:
    """Entity for manufacturing inventory"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingInventoryInMemoryRepository(BaseManufacturingRepository[ManufacturingInventoryEntity]):
    """In-memory repository for manufacturing inventory"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingInventoryEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingInventoryEntity) -> ManufacturingInventoryEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingInventoryEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingInventoryEntity) -> ManufacturingInventoryEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingInventoryEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingInventoryEntity]:
...
class ManufacturingInventoryCachedRepository(BaseManufacturingRepository[ManufacturingInventoryEntity]):
    """Cached repository wrapper for manufacturing inventory"""
...
class ManufacturingInventoryUnitOfWork:
    """Unit of Work pattern for manufacturing inventory"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingInventoryEntity] = []
        self._dirty: List[ManufacturingInventoryEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingInventoryEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingInventoryEntity) -> None:
