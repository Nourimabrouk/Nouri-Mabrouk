"""
Manufacturing Transaction Repository
...
@dataclass
class ManufacturingTransactionEntity:
    """Entity for manufacturing transaction"""
    id: str
    data: Dict[str, Any]
...
class BaseManufacturingRepository(ABC, Generic[T]):
    """Base repository for manufacturing"""
...
class ManufacturingTransactionInMemoryRepository(BaseManufacturingRepository[ManufacturingTransactionEntity]):
    """In-memory repository for manufacturing transaction"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingTransactionEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingTransactionEntity) -> ManufacturingTransactionEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingTransactionEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingTransactionEntity) -> ManufacturingTransactionEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingTransactionEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingTransactionEntity]:
...
class ManufacturingTransactionCachedRepository(BaseManufacturingRepository[ManufacturingTransactionEntity]):
    """Cached repository wrapper for manufacturing transaction"""

    def __init__(self, base_repo: BaseManufacturingRepository, cache_ttl: int = 300):
...
class ManufacturingTransactionUnitOfWork:
    """Unit of Work pattern for manufacturing transaction"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingTransactionEntity] = []
        self._dirty: List[ManufacturingTransactionEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingTransactionEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingTransactionEntity) -> None:
