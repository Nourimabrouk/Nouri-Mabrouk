"""
Manufacturing Report Repository
...
@dataclass
class ManufacturingReportEntity:
    """Entity for manufacturing report"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingReportInMemoryRepository(BaseManufacturingRepository[ManufacturingReportEntity]):
    """In-memory repository for manufacturing report"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingReportEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingReportEntity) -> ManufacturingReportEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingReportEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingReportEntity) -> ManufacturingReportEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingReportEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingReportEntity]:
...
class ManufacturingReportCachedRepository(BaseManufacturingRepository[ManufacturingReportEntity]):
    """Cached repository wrapper for manufacturing report"""
...
class ManufacturingReportUnitOfWork:
    """Unit of Work pattern for manufacturing report"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingReportEntity] = []
        self._dirty: List[ManufacturingReportEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingReportEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingReportEntity) -> None:
