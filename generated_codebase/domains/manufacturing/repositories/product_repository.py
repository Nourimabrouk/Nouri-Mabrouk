"""
Manufacturing Product Repository
...
@dataclass
class ManufacturingProductEntity:
    """Entity for manufacturing product"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingProductInMemoryRepository(BaseManufacturingRepository[ManufacturingProductEntity]):
    """In-memory repository for manufacturing product"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingProductEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingProductEntity) -> ManufacturingProductEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingProductEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingProductEntity) -> ManufacturingProductEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingProductEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingProductEntity]:
...
class ManufacturingProductCachedRepository(BaseManufacturingRepository[ManufacturingProductEntity]):
    """Cached repository wrapper for manufacturing product"""
...
class ManufacturingProductUnitOfWork:
    """Unit of Work pattern for manufacturing product"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingProductEntity] = []
        self._dirty: List[ManufacturingProductEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingProductEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingProductEntity) -> None:
