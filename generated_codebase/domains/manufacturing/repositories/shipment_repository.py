"""
Manufacturing Shipment Repository
...
@dataclass
class ManufacturingShipmentEntity:
    """Entity for manufacturing shipment"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingShipmentInMemoryRepository(BaseManufacturingRepository[ManufacturingShipmentEntity]):
    """In-memory repository for manufacturing shipment"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingShipmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingShipmentEntity) -> ManufacturingShipmentEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingShipmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingShipmentEntity) -> ManufacturingShipmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingShipmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingShipmentEntity]:
...
class ManufacturingShipmentCachedRepository(BaseManufacturingRepository[ManufacturingShipmentEntity]):
    """Cached repository wrapper for manufacturing shipment"""
...
class ManufacturingShipmentUnitOfWork:
    """Unit of Work pattern for manufacturing shipment"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingShipmentEntity] = []
        self._dirty: List[ManufacturingShipmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingShipmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingShipmentEntity) -> None:
