"""
Manufacturing Contract Repository
...
@dataclass
class ManufacturingContractEntity:
    """Entity for manufacturing contract"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingContractInMemoryRepository(BaseManufacturingRepository[ManufacturingContractEntity]):
    """In-memory repository for manufacturing contract"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingContractEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingContractEntity) -> ManufacturingContractEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingContractEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingContractEntity) -> ManufacturingContractEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingContractEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingContractEntity]:
...
class ManufacturingContractCachedRepository(BaseManufacturingRepository[ManufacturingContractEntity]):
    """Cached repository wrapper for manufacturing contract"""
...
class ManufacturingContractUnitOfWork:
    """Unit of Work pattern for manufacturing contract"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingContractEntity] = []
        self._dirty: List[ManufacturingContractEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingContractEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingContractEntity) -> None:
