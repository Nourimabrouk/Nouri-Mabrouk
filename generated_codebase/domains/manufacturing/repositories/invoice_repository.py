"""
Manufacturing Invoice Repository
...
@dataclass
class ManufacturingInvoiceEntity:
    """Entity for manufacturing invoice"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingInvoiceInMemoryRepository(BaseManufacturingRepository[ManufacturingInvoiceEntity]):
    """In-memory repository for manufacturing invoice"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingInvoiceEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingInvoiceEntity) -> ManufacturingInvoiceEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingInvoiceEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingInvoiceEntity) -> ManufacturingInvoiceEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingInvoiceEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingInvoiceEntity]:
...
class ManufacturingInvoiceCachedRepository(BaseManufacturingRepository[ManufacturingInvoiceEntity]):
    """Cached repository wrapper for manufacturing invoice"""
...
class ManufacturingInvoiceUnitOfWork:
    """Unit of Work pattern for manufacturing invoice"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingInvoiceEntity] = []
        self._dirty: List[ManufacturingInvoiceEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingInvoiceEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingInvoiceEntity) -> None:
