"""
Manufacturing Supplier Repository
...
@dataclass
class ManufacturingSupplierEntity:
    """Entity for manufacturing supplier"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingSupplierInMemoryRepository(BaseManufacturingRepository[ManufacturingSupplierEntity]):
    """In-memory repository for manufacturing supplier"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingSupplierEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingSupplierEntity) -> ManufacturingSupplierEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingSupplierEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingSupplierEntity) -> ManufacturingSupplierEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingSupplierEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingSupplierEntity]:
...
class ManufacturingSupplierCachedRepository(BaseManufacturingRepository[ManufacturingSupplierEntity]):
    """Cached repository wrapper for manufacturing supplier"""
...
class ManufacturingSupplierUnitOfWork:
    """Unit of Work pattern for manufacturing supplier"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingSupplierEntity] = []
        self._dirty: List[ManufacturingSupplierEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingSupplierEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingSupplierEntity) -> None:
