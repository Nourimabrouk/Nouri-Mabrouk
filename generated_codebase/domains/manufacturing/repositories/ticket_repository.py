"""
Manufacturing Ticket Repository
...
@dataclass
class ManufacturingTicketEntity:
    """Entity for manufacturing ticket"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingTicketInMemoryRepository(BaseManufacturingRepository[ManufacturingTicketEntity]):
    """In-memory repository for manufacturing ticket"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingTicketEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingTicketEntity) -> ManufacturingTicketEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingTicketEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingTicketEntity) -> ManufacturingTicketEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingTicketEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingTicketEntity]:
...
class ManufacturingTicketCachedRepository(BaseManufacturingRepository[ManufacturingTicketEntity]):
    """Cached repository wrapper for manufacturing ticket"""
...
class ManufacturingTicketUnitOfWork:
    """Unit of Work pattern for manufacturing ticket"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingTicketEntity] = []
        self._dirty: List[ManufacturingTicketEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingTicketEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingTicketEntity) -> None:
