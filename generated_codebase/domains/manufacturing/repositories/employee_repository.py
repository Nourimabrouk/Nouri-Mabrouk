"""
Manufacturing Employee Repository
...
@dataclass
class ManufacturingEmployeeEntity:
    """Entity for manufacturing employee"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingEmployeeInMemoryRepository(BaseManufacturingRepository[ManufacturingEmployeeEntity]):
    """In-memory repository for manufacturing employee"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingEmployeeEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingEmployeeEntity) -> ManufacturingEmployeeEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingEmployeeEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingEmployeeEntity) -> ManufacturingEmployeeEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingEmployeeEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingEmployeeEntity]:
...
class ManufacturingEmployeeCachedRepository(BaseManufacturingRepository[ManufacturingEmployeeEntity]):
    """Cached repository wrapper for manufacturing employee"""
...
class ManufacturingEmployeeUnitOfWork:
    """Unit of Work pattern for manufacturing employee"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingEmployeeEntity] = []
        self._dirty: List[ManufacturingEmployeeEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingEmployeeEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingEmployeeEntity) -> None:
