"""
Manufacturing Appointment Repository
...
@dataclass
class ManufacturingAppointmentEntity:
    """Entity for manufacturing appointment"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingAppointmentInMemoryRepository(BaseManufacturingRepository[ManufacturingAppointmentEntity]):
    """In-memory repository for manufacturing appointment"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingAppointmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingAppointmentEntity) -> ManufacturingAppointmentEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingAppointmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingAppointmentEntity) -> ManufacturingAppointmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingAppointmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingAppointmentEntity]:
...
class ManufacturingAppointmentCachedRepository(BaseManufacturingRepository[ManufacturingAppointmentEntity]):
    """Cached repository wrapper for manufacturing appointment"""
...
class ManufacturingAppointmentUnitOfWork:
    """Unit of Work pattern for manufacturing appointment"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingAppointmentEntity] = []
        self._dirty: List[ManufacturingAppointmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingAppointmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingAppointmentEntity) -> None:
