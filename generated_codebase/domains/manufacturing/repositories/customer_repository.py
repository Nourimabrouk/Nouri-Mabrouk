"""
Manufacturing Customer Repository
...
@dataclass
class ManufacturingCustomerEntity:
    """Entity for manufacturing customer"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingCustomerInMemoryRepository(BaseManufacturingRepository[ManufacturingCustomerEntity]):
    """In-memory repository for manufacturing customer"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingCustomerEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingCustomerEntity) -> ManufacturingCustomerEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingCustomerEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingCustomerEntity) -> ManufacturingCustomerEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingCustomerEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingCustomerEntity]:
...
class ManufacturingCustomerCachedRepository(BaseManufacturingRepository[ManufacturingCustomerEntity]):
    """Cached repository wrapper for manufacturing customer"""
...
class ManufacturingCustomerUnitOfWork:
    """Unit of Work pattern for manufacturing customer"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingCustomerEntity] = []
        self._dirty: List[ManufacturingCustomerEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingCustomerEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingCustomerEntity) -> None:
