...
class ManufacturingOrderEntity:
    """Entity for manufacturing order"""
    id: str
    data: Dict[str, Any]
...
class ManufacturingOrderInMemoryRepository(BaseManufacturingRepository[ManufacturingOrderEntity]):
    """In-memory repository for manufacturing order"""

    def __init__(self):
        self._storage: Dict[str, ManufacturingOrderEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: ManufacturingOrderEntity) -> ManufacturingOrderEntity:
    ...
    async def read(self, id: str) -> Optional[ManufacturingOrderEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: ManufacturingOrderEntity) -> ManufacturingOrderEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[ManufacturingOrderEntity]:
    ...
    async def find_by(self, **kwargs) -> List[ManufacturingOrderEntity]:
...
class ManufacturingOrderCachedRepository(BaseManufacturingRepository[ManufacturingOrderEntity]):
    """Cached repository wrapper for manufacturing order"""
...
class ManufacturingOrderUnitOfWork:
    """Unit of Work pattern for manufacturing order"""

    def __init__(self, repository: BaseManufacturingRepository):
        self._repository = repository
        self._new: List[ManufacturingOrderEntity] = []
        self._dirty: List[ManufacturingOrderEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: ManufacturingOrderEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: ManufacturingOrderEntity) -> None:
