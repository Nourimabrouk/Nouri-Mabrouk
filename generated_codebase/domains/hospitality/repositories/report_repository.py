...
@dataclass
class HospitalityReportEntity:
    """Entity for hospitality report"""
    id: str
    data: Dict[str, Any]
...
class HospitalityReportInMemoryRepository(BaseHospitalityRepository[HospitalityReportEntity]):
    """In-memory repository for hospitality report"""

    def __init__(self):
        self._storage: Dict[str, HospitalityReportEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HospitalityReportEntity) -> HospitalityReportEntity:
    ...
    async def read(self, id: str) -> Optional[HospitalityReportEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HospitalityReportEntity) -> HospitalityReportEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HospitalityReportEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HospitalityReportEntity]:
...
class HospitalityReportCachedRepository(BaseHospitalityRepository[HospitalityReportEntity]):
    """Cached repository wrapper for hospitality report"""
...
class HospitalityReportUnitOfWork:
    """Unit of Work pattern for hospitality report"""

    def __init__(self, repository: BaseHospitalityRepository):
        self._repository = repository
        self._new: List[HospitalityReportEntity] = []
        self._dirty: List[HospitalityReportEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HospitalityReportEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HospitalityReportEntity) -> None:
