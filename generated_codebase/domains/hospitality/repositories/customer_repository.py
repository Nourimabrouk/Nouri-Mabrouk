"""
Hospitality Customer Repository
...
@dataclass
class HospitalityCustomerEntity:
    """Entity for hospitality customer"""
    id: str
    data: Dict[str, Any]
...
class HospitalityCustomerInMemoryRepository(BaseHospitalityRepository[HospitalityCustomerEntity]):
    """In-memory repository for hospitality customer"""

    def __init__(self):
        self._storage: Dict[str, HospitalityCustomerEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HospitalityCustomerEntity) -> HospitalityCustomerEntity:
    ...
    async def read(self, id: str) -> Optional[HospitalityCustomerEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HospitalityCustomerEntity) -> HospitalityCustomerEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HospitalityCustomerEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HospitalityCustomerEntity]:
...
class HospitalityCustomerCachedRepository(BaseHospitalityRepository[HospitalityCustomerEntity]):
    """Cached repository wrapper for hospitality customer"""
...
class HospitalityCustomerUnitOfWork:
    """Unit of Work pattern for hospitality customer"""

    def __init__(self, repository: BaseHospitalityRepository):
        self._repository = repository
        self._new: List[HospitalityCustomerEntity] = []
        self._dirty: List[HospitalityCustomerEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HospitalityCustomerEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HospitalityCustomerEntity) -> None:
