...
@dataclass
class HospitalityTicketEntity:
    """Entity for hospitality ticket"""
    id: str
    data: Dict[str, Any]
...
class HospitalityTicketInMemoryRepository(BaseHospitalityRepository[HospitalityTicketEntity]):
    """In-memory repository for hospitality ticket"""

    def __init__(self):
        self._storage: Dict[str, HospitalityTicketEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HospitalityTicketEntity) -> HospitalityTicketEntity:
    ...
    async def read(self, id: str) -> Optional[HospitalityTicketEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HospitalityTicketEntity) -> HospitalityTicketEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HospitalityTicketEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HospitalityTicketEntity]:
...
class HospitalityTicketCachedRepository(BaseHospitalityRepository[HospitalityTicketEntity]):
    """Cached repository wrapper for hospitality ticket"""
...
class HospitalityTicketUnitOfWork:
    """Unit of Work pattern for hospitality ticket"""

    def __init__(self, repository: BaseHospitalityRepository):
        self._repository = repository
        self._new: List[HospitalityTicketEntity] = []
        self._dirty: List[HospitalityTicketEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HospitalityTicketEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HospitalityTicketEntity) -> None:
