"""
Hospitality Contract Repository
...
@dataclass
class HospitalityContractEntity:
    """Entity for hospitality contract"""
    id: str
    data: Dict[str, Any]
...
class HospitalityContractInMemoryRepository(BaseHospitalityRepository[HospitalityContractEntity]):
    """In-memory repository for hospitality contract"""

    def __init__(self):
        self._storage: Dict[str, HospitalityContractEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HospitalityContractEntity) -> HospitalityContractEntity:
    ...
    async def read(self, id: str) -> Optional[HospitalityContractEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HospitalityContractEntity) -> HospitalityContractEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HospitalityContractEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HospitalityContractEntity]:
...
class HospitalityContractCachedRepository(BaseHospitalityRepository[HospitalityContractEntity]):
    """Cached repository wrapper for hospitality contract"""
...
class HospitalityContractUnitOfWork:
    """Unit of Work pattern for hospitality contract"""

    def __init__(self, repository: BaseHospitalityRepository):
        self._repository = repository
        self._new: List[HospitalityContractEntity] = []
        self._dirty: List[HospitalityContractEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HospitalityContractEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HospitalityContractEntity) -> None:
