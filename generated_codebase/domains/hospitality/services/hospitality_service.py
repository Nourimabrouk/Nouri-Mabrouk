...
class BaseHospitalityService(ABC):
    """Base service class for hospitality"""
...
class HospitalityAPIService(BaseHospitalityService):
    """REST API service for hospitality"""
...
class HospitalityGRPCService(BaseHospitalityService):
    """gRPC service for hospitality"""
...
class HospitalityWebSocketService(BaseHospitalityService):
    """WebSocket service for hospitality"""
...
class HospitalityEventService(BaseHospitalityService):
    """Event-driven service for hospitality"""
...
class HospitalityServiceRegistry:
    """Service registry for hospitality"""

    _services: Dict[str, BaseHospitalityService] = {}

    @classmethod
    def register(cls, name: str, service: BaseHospitalityService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseHospitalityService]:
