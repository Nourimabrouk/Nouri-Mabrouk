...
class BaseAutomotiveService(ABC):
    """Base service class for automotive"""
...
class AutomotiveAPIService(BaseAutomotiveService):
    """REST API service for automotive"""
...
class AutomotiveGRPCService(BaseAutomotiveService):
    """gRPC service for automotive"""
...
class AutomotiveWebSocketService(BaseAutomotiveService):
    """WebSocket service for automotive"""
...
class AutomotiveEventService(BaseAutomotiveService):
    """Event-driven service for automotive"""
...
class AutomotiveServiceRegistry:
    """Service registry for automotive"""

    _services: Dict[str, BaseAutomotiveService] = {}

    @classmethod
    def register(cls, name: str, service: BaseAutomotiveService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseAutomotiveService]:
