"""
Automotive Shipment Repository
...
@dataclass
class AutomotiveShipmentEntity:
    """Entity for automotive shipment"""
    id: str
    data: Dict[str, Any]
...
class AutomotiveShipmentInMemoryRepository(BaseAutomotiveRepository[AutomotiveShipmentEntity]):
    """In-memory repository for automotive shipment"""

    def __init__(self):
        self._storage: Dict[str, AutomotiveShipmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AutomotiveShipmentEntity) -> AutomotiveShipmentEntity:
    ...
    async def read(self, id: str) -> Optional[AutomotiveShipmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AutomotiveShipmentEntity) -> AutomotiveShipmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AutomotiveShipmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AutomotiveShipmentEntity]:
...
class AutomotiveShipmentCachedRepository(BaseAutomotiveRepository[AutomotiveShipmentEntity]):
    """Cached repository wrapper for automotive shipment"""
...
class AutomotiveShipmentUnitOfWork:
    """Unit of Work pattern for automotive shipment"""

    def __init__(self, repository: BaseAutomotiveRepository):
        self._repository = repository
        self._new: List[AutomotiveShipmentEntity] = []
        self._dirty: List[AutomotiveShipmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AutomotiveShipmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AutomotiveShipmentEntity) -> None:
