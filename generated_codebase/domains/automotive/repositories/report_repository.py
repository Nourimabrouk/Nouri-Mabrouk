...
@dataclass
class AutomotiveReportEntity:
    """Entity for automotive report"""
    id: str
    data: Dict[str, Any]
...
class AutomotiveReportInMemoryRepository(BaseAutomotiveRepository[AutomotiveReportEntity]):
    """In-memory repository for automotive report"""

    def __init__(self):
        self._storage: Dict[str, AutomotiveReportEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AutomotiveReportEntity) -> AutomotiveReportEntity:
    ...
    async def read(self, id: str) -> Optional[AutomotiveReportEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AutomotiveReportEntity) -> AutomotiveReportEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AutomotiveReportEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AutomotiveReportEntity]:
...
class AutomotiveReportCachedRepository(BaseAutomotiveRepository[AutomotiveReportEntity]):
    """Cached repository wrapper for automotive report"""
...
class AutomotiveReportUnitOfWork:
    """Unit of Work pattern for automotive report"""

    def __init__(self, repository: BaseAutomotiveRepository):
        self._repository = repository
        self._new: List[AutomotiveReportEntity] = []
        self._dirty: List[AutomotiveReportEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AutomotiveReportEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AutomotiveReportEntity) -> None:
