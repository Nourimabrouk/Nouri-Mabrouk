...
@dataclass
class AutomotivePaymentEntity:
    """Entity for automotive payment"""
    id: str
    data: Dict[str, Any]
...
class AutomotivePaymentInMemoryRepository(BaseAutomotiveRepository[AutomotivePaymentEntity]):
    """In-memory repository for automotive payment"""

    def __init__(self):
        self._storage: Dict[str, AutomotivePaymentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AutomotivePaymentEntity) -> AutomotivePaymentEntity:
    ...
    async def read(self, id: str) -> Optional[AutomotivePaymentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AutomotivePaymentEntity) -> AutomotivePaymentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AutomotivePaymentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AutomotivePaymentEntity]:
...
class AutomotivePaymentCachedRepository(BaseAutomotiveRepository[AutomotivePaymentEntity]):
    """Cached repository wrapper for automotive payment"""
...
class AutomotivePaymentUnitOfWork:
    """Unit of Work pattern for automotive payment"""

    def __init__(self, repository: BaseAutomotiveRepository):
        self._repository = repository
        self._new: List[AutomotivePaymentEntity] = []
        self._dirty: List[AutomotivePaymentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AutomotivePaymentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AutomotivePaymentEntity) -> None:
