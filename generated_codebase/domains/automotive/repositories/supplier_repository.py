"""
Automotive Supplier Repository
...
@dataclass
class AutomotiveSupplierEntity:
    """Entity for automotive supplier"""
    id: str
    data: Dict[str, Any]
...
class AutomotiveSupplierInMemoryRepository(BaseAutomotiveRepository[AutomotiveSupplierEntity]):
    """In-memory repository for automotive supplier"""

    def __init__(self):
        self._storage: Dict[str, AutomotiveSupplierEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AutomotiveSupplierEntity) -> AutomotiveSupplierEntity:
    ...
    async def read(self, id: str) -> Optional[AutomotiveSupplierEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AutomotiveSupplierEntity) -> AutomotiveSupplierEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AutomotiveSupplierEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AutomotiveSupplierEntity]:
...
class AutomotiveSupplierCachedRepository(BaseAutomotiveRepository[AutomotiveSupplierEntity]):
    """Cached repository wrapper for automotive supplier"""
...
class AutomotiveSupplierUnitOfWork:
    """Unit of Work pattern for automotive supplier"""

    def __init__(self, repository: BaseAutomotiveRepository):
        self._repository = repository
        self._new: List[AutomotiveSupplierEntity] = []
        self._dirty: List[AutomotiveSupplierEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AutomotiveSupplierEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AutomotiveSupplierEntity) -> None:
