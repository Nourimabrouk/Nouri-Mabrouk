...
@dataclass
class AutomotiveTicketEntity:
    """Entity for automotive ticket"""
    id: str
    data: Dict[str, Any]
...
class AutomotiveTicketInMemoryRepository(BaseAutomotiveRepository[AutomotiveTicketEntity]):
    """In-memory repository for automotive ticket"""

    def __init__(self):
        self._storage: Dict[str, AutomotiveTicketEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AutomotiveTicketEntity) -> AutomotiveTicketEntity:
    ...
    async def read(self, id: str) -> Optional[AutomotiveTicketEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AutomotiveTicketEntity) -> AutomotiveTicketEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AutomotiveTicketEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AutomotiveTicketEntity]:
...
class AutomotiveTicketCachedRepository(BaseAutomotiveRepository[AutomotiveTicketEntity]):
    """Cached repository wrapper for automotive ticket"""
...
class AutomotiveTicketUnitOfWork:
    """Unit of Work pattern for automotive ticket"""

    def __init__(self, repository: BaseAutomotiveRepository):
        self._repository = repository
        self._new: List[AutomotiveTicketEntity] = []
        self._dirty: List[AutomotiveTicketEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AutomotiveTicketEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AutomotiveTicketEntity) -> None:
