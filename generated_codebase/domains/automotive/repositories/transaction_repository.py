"""
Automotive Transaction Repository
...
@dataclass
class AutomotiveTransactionEntity:
    """Entity for automotive transaction"""
    id: str
    data: Dict[str, Any]
...
class AutomotiveTransactionInMemoryRepository(BaseAutomotiveRepository[AutomotiveTransactionEntity]):
    """In-memory repository for automotive transaction"""

    def __init__(self):
        self._storage: Dict[str, AutomotiveTransactionEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AutomotiveTransactionEntity) -> AutomotiveTransactionEntity:
    ...
    async def read(self, id: str) -> Optional[AutomotiveTransactionEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AutomotiveTransactionEntity) -> AutomotiveTransactionEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AutomotiveTransactionEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AutomotiveTransactionEntity]:
...
class AutomotiveTransactionCachedRepository(BaseAutomotiveRepository[AutomotiveTransactionEntity]):
    """Cached repository wrapper for automotive transaction"""
...
class AutomotiveTransactionUnitOfWork:
    """Unit of Work pattern for automotive transaction"""

    def __init__(self, repository: BaseAutomotiveRepository):
        self._repository = repository
        self._new: List[AutomotiveTransactionEntity] = []
        self._dirty: List[AutomotiveTransactionEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AutomotiveTransactionEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AutomotiveTransactionEntity) -> None:
