...
@dataclass
class AutomotiveProductEntity:
    """Entity for automotive product"""
    id: str
    data: Dict[str, Any]
...
class AutomotiveProductInMemoryRepository(BaseAutomotiveRepository[AutomotiveProductEntity]):
    """In-memory repository for automotive product"""

    def __init__(self):
        self._storage: Dict[str, AutomotiveProductEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AutomotiveProductEntity) -> AutomotiveProductEntity:
    ...
    async def read(self, id: str) -> Optional[AutomotiveProductEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AutomotiveProductEntity) -> AutomotiveProductEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AutomotiveProductEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AutomotiveProductEntity]:
...
class AutomotiveProductCachedRepository(BaseAutomotiveRepository[AutomotiveProductEntity]):
    """Cached repository wrapper for automotive product"""
...
class AutomotiveProductUnitOfWork:
    """Unit of Work pattern for automotive product"""

    def __init__(self, repository: BaseAutomotiveRepository):
        self._repository = repository
        self._new: List[AutomotiveProductEntity] = []
        self._dirty: List[AutomotiveProductEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AutomotiveProductEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AutomotiveProductEntity) -> None:
