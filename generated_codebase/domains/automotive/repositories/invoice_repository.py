...
@dataclass
class AutomotiveInvoiceEntity:
    """Entity for automotive invoice"""
    id: str
    data: Dict[str, Any]
...
class AutomotiveInvoiceInMemoryRepository(BaseAutomotiveRepository[AutomotiveInvoiceEntity]):
    """In-memory repository for automotive invoice"""

    def __init__(self):
        self._storage: Dict[str, AutomotiveInvoiceEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AutomotiveInvoiceEntity) -> AutomotiveInvoiceEntity:
    ...
    async def read(self, id: str) -> Optional[AutomotiveInvoiceEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AutomotiveInvoiceEntity) -> AutomotiveInvoiceEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AutomotiveInvoiceEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AutomotiveInvoiceEntity]:
...
class AutomotiveInvoiceCachedRepository(BaseAutomotiveRepository[AutomotiveInvoiceEntity]):
    """Cached repository wrapper for automotive invoice"""
...
class AutomotiveInvoiceUnitOfWork:
    """Unit of Work pattern for automotive invoice"""

    def __init__(self, repository: BaseAutomotiveRepository):
        self._repository = repository
        self._new: List[AutomotiveInvoiceEntity] = []
        self._dirty: List[AutomotiveInvoiceEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AutomotiveInvoiceEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AutomotiveInvoiceEntity) -> None:
