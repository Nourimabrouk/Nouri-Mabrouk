...
class BaseEnergyService(ABC):
    """Base service class for energy"""
...
class EnergyAPIService(BaseEnergyService):
    """REST API service for energy"""
...
class EnergyGRPCService(BaseEnergyService):
    """gRPC service for energy"""
...
class EnergyWebSocketService(BaseEnergyService):
    """WebSocket service for energy"""
...
class EnergyEventService(BaseEnergyService):
    """Event-driven service for energy"""
...
class EnergyServiceRegistry:
    """Service registry for energy"""

    _services: Dict[str, BaseEnergyService] = {}

    @classmethod
    def register(cls, name: str, service: BaseEnergyService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseEnergyService]:
