...
@dataclass
class EnergyAppointmentEntity:
    """Entity for energy appointment"""
    id: str
    data: Dict[str, Any]
...
class EnergyAppointmentInMemoryRepository(BaseEnergyRepository[EnergyAppointmentEntity]):
    """In-memory repository for energy appointment"""

    def __init__(self):
        self._storage: Dict[str, EnergyAppointmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: EnergyAppointmentEntity) -> EnergyAppointmentEntity:
    ...
    async def read(self, id: str) -> Optional[EnergyAppointmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: EnergyAppointmentEntity) -> EnergyAppointmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[EnergyAppointmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[EnergyAppointmentEntity]:
...
class EnergyAppointmentCachedRepository(BaseEnergyRepository[EnergyAppointmentEntity]):
    """Cached repository wrapper for energy appointment"""
...
class EnergyAppointmentUnitOfWork:
    """Unit of Work pattern for energy appointment"""

    def __init__(self, repository: BaseEnergyRepository):
        self._repository = repository
        self._new: List[EnergyAppointmentEntity] = []
        self._dirty: List[EnergyAppointmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: EnergyAppointmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: EnergyAppointmentEntity) -> None:
