...
class BaseRetailService(ABC):
    """Base service class for retail"""
...
class RetailAPIService(BaseRetailService):
    """REST API service for retail"""
...
class RetailGRPCService(BaseRetailService):
    """gRPC service for retail"""
...
class RetailWebSocketService(BaseRetailService):
    """WebSocket service for retail"""
...
class RetailEventService(BaseRetailService):
    """Event-driven service for retail"""
...
class RetailServiceRegistry:
    """Service registry for retail"""

    _services: Dict[str, BaseRetailService] = {}

    @classmethod
    def register(cls, name: str, service: BaseRetailService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseRetailService]:
