...
class BaseAgricultureService(ABC):
    """Base service class for agriculture"""
...
class AgricultureAPIService(BaseAgricultureService):
    """REST API service for agriculture"""
...
class AgricultureGRPCService(BaseAgricultureService):
    """gRPC service for agriculture"""
...
class AgricultureWebSocketService(BaseAgricultureService):
    """WebSocket service for agriculture"""
...
class AgricultureEventService(BaseAgricultureService):
    """Event-driven service for agriculture"""
...
class AgricultureServiceRegistry:
    """Service registry for agriculture"""

    _services: Dict[str, BaseAgricultureService] = {}

    @classmethod
    def register(cls, name: str, service: BaseAgricultureService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseAgricultureService]:
