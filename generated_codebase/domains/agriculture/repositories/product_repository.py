"""
Agriculture Product Repository
...
@dataclass
class AgricultureProductEntity:
    """Entity for agriculture product"""
    id: str
    data: Dict[str, Any]
...
class AgricultureProductInMemoryRepository(BaseAgricultureRepository[AgricultureProductEntity]):
    """In-memory repository for agriculture product"""

    def __init__(self):
        self._storage: Dict[str, AgricultureProductEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AgricultureProductEntity) -> AgricultureProductEntity:
    ...
    async def read(self, id: str) -> Optional[AgricultureProductEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AgricultureProductEntity) -> AgricultureProductEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AgricultureProductEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AgricultureProductEntity]:
...
class AgricultureProductCachedRepository(BaseAgricultureRepository[AgricultureProductEntity]):
    """Cached repository wrapper for agriculture product"""
...
class AgricultureProductUnitOfWork:
    """Unit of Work pattern for agriculture product"""

    def __init__(self, repository: BaseAgricultureRepository):
        self._repository = repository
        self._new: List[AgricultureProductEntity] = []
        self._dirty: List[AgricultureProductEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AgricultureProductEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AgricultureProductEntity) -> None:
