"""
Agriculture Customer Repository
...
@dataclass
class AgricultureCustomerEntity:
    """Entity for agriculture customer"""
    id: str
    data: Dict[str, Any]
...
class AgricultureCustomerInMemoryRepository(BaseAgricultureRepository[AgricultureCustomerEntity]):
    """In-memory repository for agriculture customer"""

    def __init__(self):
        self._storage: Dict[str, AgricultureCustomerEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AgricultureCustomerEntity) -> AgricultureCustomerEntity:
    ...
    async def read(self, id: str) -> Optional[AgricultureCustomerEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AgricultureCustomerEntity) -> AgricultureCustomerEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AgricultureCustomerEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AgricultureCustomerEntity]:
...
class AgricultureCustomerCachedRepository(BaseAgricultureRepository[AgricultureCustomerEntity]):
    """Cached repository wrapper for agriculture customer"""
...
class AgricultureCustomerUnitOfWork:
    """Unit of Work pattern for agriculture customer"""

    def __init__(self, repository: BaseAgricultureRepository):
        self._repository = repository
        self._new: List[AgricultureCustomerEntity] = []
        self._dirty: List[AgricultureCustomerEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AgricultureCustomerEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AgricultureCustomerEntity) -> None:
