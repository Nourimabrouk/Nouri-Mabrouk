"""
Agriculture Appointment Repository
...
@dataclass
class AgricultureAppointmentEntity:
    """Entity for agriculture appointment"""
    id: str
    data: Dict[str, Any]
...
class AgricultureAppointmentInMemoryRepository(BaseAgricultureRepository[AgricultureAppointmentEntity]):
    """In-memory repository for agriculture appointment"""

    def __init__(self):
        self._storage: Dict[str, AgricultureAppointmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AgricultureAppointmentEntity) -> AgricultureAppointmentEntity:
    ...
    async def read(self, id: str) -> Optional[AgricultureAppointmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AgricultureAppointmentEntity) -> AgricultureAppointmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AgricultureAppointmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AgricultureAppointmentEntity]:
...
class AgricultureAppointmentCachedRepository(BaseAgricultureRepository[AgricultureAppointmentEntity]):
    """Cached repository wrapper for agriculture appointment"""
...
class AgricultureAppointmentUnitOfWork:
    """Unit of Work pattern for agriculture appointment"""

    def __init__(self, repository: BaseAgricultureRepository):
        self._repository = repository
        self._new: List[AgricultureAppointmentEntity] = []
        self._dirty: List[AgricultureAppointmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AgricultureAppointmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AgricultureAppointmentEntity) -> None:
