...
class BaseFinanceService(ABC):
    """Base service class for finance"""
...
class FinanceAPIService(BaseFinanceService):
    """REST API service for finance"""
...
class FinanceGRPCService(BaseFinanceService):
    """gRPC service for finance"""
...
class FinanceWebSocketService(BaseFinanceService):
    """WebSocket service for finance"""
...
class FinanceEventService(BaseFinanceService):
    """Event-driven service for finance"""
...
class FinanceServiceRegistry:
    """Service registry for finance"""

    _services: Dict[str, BaseFinanceService] = {}

    @classmethod
    def register(cls, name: str, service: BaseFinanceService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseFinanceService]:
