...
# Route definitions for finance domain
ROUTES = {
    ...
    "endpoints": [
        {
            "path": "/",
            "method": "GET",
            "handler": "list_finance",
            "description": "List all finance resources",
            "auth_required": True,
            "rate_limit": 100
        },
        {
        ...
        },
        {
            ...
            "method": "GET",
            "handler": "get_finance",
            "description": "Get finance resource by ID",
            "auth_required": True,
            "rate_limit": 200
        },
        {
        ...
        },
        {
            "path": "/search",
            "method": "POST",
            "handler": "search_finance",
            "description": "Search finance resources",
            "auth_required": True,
            "rate_limit": 100
        },
        {
            "path": "/bulk",
            "method": "POST",
            "handler": "bulk_create_finance",
            "description": "Bulk create finance resources",
            "auth_required": True,
            "rate_limit": 10
        },
        {
        ...
        },
        {
            "path": "/stats",
            "method": "GET",
            "handler": "get_finance_stats",
            "description": "Get finance statistics",
            "auth_required": True,
            "rate_limit": 50
        }
    ]
...
class FinanceRouteHandler:
    """Route handler for finance"""
    ...
    async def list_finance(self, params: Dict[str, Any]) -> RouteResponse:
        """List finance resources"""
        try:
            ...
            return RouteResponse(
                ...
                metadata={"endpoint": "list_finance"}
            )
        except Exception as e:
            logger.error(f"Error listing finance: {e}")
            return RouteResponse(success=False, error=str(e))

    async def create_finance(self, data: Dict[str, Any]) -> RouteResponse:
        ...
        try:
            ...
            return RouteResponse(
                success=True,
                data=result,
                metadata={"endpoint": "create_finance"}
            )
        except Exception as e:
            logger.error(f"Error creating finance: {e}")
            return RouteResponse(success=False, error=str(e))

    async def get_finance(self, id: str) -> RouteResponse:
        """Get finance resource by ID"""
        try:
            # result = await self.repository.read(id)
            result = {"id": id, "name": f"finance_{id}"}
            ...
            logger.error(f"Error getting finance {id}: {e}")
            return RouteResponse(success=False, error=str(e))

    async def update_finance(self, id: str, data: Dict[str, Any]) -> RouteResponse:
        """Update finance resource"""
        try:
            ...
            return RouteResponse(
                success=True,
                data=result,
                metadata={"endpoint": "update_finance"}
            )
        except Exception as e:
            logger.error(f"Error updating finance {id}: {e}")
            return RouteResponse(success=False, error=str(e))

    async def delete_finance(self, id: str) -> RouteResponse:
        """Delete finance resource"""
        try:
            ...
            logger.error(f"Error deleting finance {id}: {e}")
            return RouteResponse(success=False, error=str(e))

    async def search_finance(self, query: Dict[str, Any]) -> RouteResponse:
        """Search finance resources"""
        try:
    ...
    async def bulk_create_finance(self, items: List[Dict[str, Any]]) -> RouteResponse:
        """Bulk create finance resources"""
        try:
            created = []
            errors = []
            ...
            logger.error(f"Error bulk creating finance: {e}")
            return RouteResponse(success=False, error=str(e))

    async def export_finance(self, params: Dict[str, Any]) -> RouteResponse:
        """Export finance data"""
        try:
            ...
            logger.error(f"Error exporting finance: {e}")
            return RouteResponse(success=False, error=str(e))

    async def import_finance(self, data: Dict[str, Any]) -> RouteResponse:
        """Import finance data"""
        try:
            ...
            logger.error(f"Error importing finance: {e}")
            return RouteResponse(success=False, error=str(e))

    async def get_finance_stats(self, params: Dict[str, Any] = None) -> RouteResponse:
...
class FinanceRouter:
    """Router for finance endpoints"""

    def __init__(self):
        self.handler = FinanceRouteHandler()
        self.routes = ROUTES
        self._middleware = []
    ...
    def get_openapi_spec(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "info": {
                "title": "Finance API",
                "version": "1.0.0",
                "description": "API for finance domain"
            },
            "paths": paths,
            "components": {
                "securitySchemes": {
