...
@dataclass
class FinanceInventoryEntity:
    """Entity for finance inventory"""
    id: str
    data: Dict[str, Any]
...
class FinanceInventoryInMemoryRepository(BaseFinanceRepository[FinanceInventoryEntity]):
    """In-memory repository for finance inventory"""

    def __init__(self):
        self._storage: Dict[str, FinanceInventoryEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: FinanceInventoryEntity) -> FinanceInventoryEntity:
    ...
    async def read(self, id: str) -> Optional[FinanceInventoryEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: FinanceInventoryEntity) -> FinanceInventoryEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[FinanceInventoryEntity]:
    ...
    async def find_by(self, **kwargs) -> List[FinanceInventoryEntity]:
...
class FinanceInventoryCachedRepository(BaseFinanceRepository[FinanceInventoryEntity]):
    """Cached repository wrapper for finance inventory"""
...
class FinanceInventoryUnitOfWork:
    """Unit of Work pattern for finance inventory"""

    def __init__(self, repository: BaseFinanceRepository):
        self._repository = repository
        self._new: List[FinanceInventoryEntity] = []
        self._dirty: List[FinanceInventoryEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: FinanceInventoryEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: FinanceInventoryEntity) -> None:
