...
@dataclass
class FinanceAssessmentEntity:
    """Entity for finance assessment"""
    id: str
    data: Dict[str, Any]
...
class FinanceAssessmentInMemoryRepository(BaseFinanceRepository[FinanceAssessmentEntity]):
    """In-memory repository for finance assessment"""

    def __init__(self):
        self._storage: Dict[str, FinanceAssessmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: FinanceAssessmentEntity) -> FinanceAssessmentEntity:
    ...
    async def read(self, id: str) -> Optional[FinanceAssessmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: FinanceAssessmentEntity) -> FinanceAssessmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[FinanceAssessmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[FinanceAssessmentEntity]:
...
class FinanceAssessmentCachedRepository(BaseFinanceRepository[FinanceAssessmentEntity]):
    """Cached repository wrapper for finance assessment"""
...
class FinanceAssessmentUnitOfWork:
    """Unit of Work pattern for finance assessment"""

    def __init__(self, repository: BaseFinanceRepository):
        self._repository = repository
        self._new: List[FinanceAssessmentEntity] = []
        self._dirty: List[FinanceAssessmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: FinanceAssessmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: FinanceAssessmentEntity) -> None:
