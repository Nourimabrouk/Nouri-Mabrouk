...
class FinanceReportInMemoryRepository(BaseFinanceRepository[FinanceReportEntity]):
    """In-memory repository for finance report"""

    def __init__(self):
        self._storage: Dict[str, FinanceReportEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: FinanceReportEntity) -> FinanceReportEntity:
    ...
    async def read(self, id: str) -> Optional[FinanceReportEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: FinanceReportEntity) -> FinanceReportEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[FinanceReportEntity]:
    ...
    async def find_by(self, **kwargs) -> List[FinanceReportEntity]:
...
class FinanceReportCachedRepository(BaseFinanceRepository[FinanceReportEntity]):
    """Cached repository wrapper for finance report"""
...
class FinanceReportUnitOfWork:
    """Unit of Work pattern for finance report"""

    def __init__(self, repository: BaseFinanceRepository):
        self._repository = repository
        self._new: List[FinanceReportEntity] = []
        self._dirty: List[FinanceReportEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: FinanceReportEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: FinanceReportEntity) -> None:
