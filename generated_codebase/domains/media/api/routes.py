...
# Route definitions for media domain
ROUTES = {
    ...
    "endpoints": [
        ...
        },
        {
            ...
            "description": "Search media resources",
            "auth_required": True,
            "rate_limit": 100
        },
        {
            "path": "/bulk",
            "method": "POST",
            "handler": "bulk_create_media",
            "description": "Bulk create media resources",
            "auth_required": True,
            "rate_limit": 10
        },
        {
            "path": "/export",
            "method": "GET",
            "handler": "export_media",
            "description": "Export media data",
            "auth_required": True,
            "rate_limit": 5
        },
        {
            "path": "/import",
            "method": "POST",
            "handler": "import_media",
            "description": "Import media data",
            "auth_required": True,
            "rate_limit": 5
        },
        {
...
class MediaRouteHandler:
    ...
    async def list_media(self, params: Dict[str, Any]) -> RouteResponse:
        ...
        try:
            ...
            return RouteResponse(
                ...
                metadata={"endpoint": "list_media"}
            )
        except Exception as e:
            logger.error(f"Error listing media: {e}")
            return RouteResponse(success=False, error=str(e))

    async def create_media(self, data: Dict[str, Any]) -> RouteResponse:
        ...
        try:
            ...
            return RouteResponse(
                success=True,
                data=result,
                metadata={"endpoint": "create_media"}
            )
        except Exception as e:
            logger.error(f"Error creating media: {e}")
            return RouteResponse(success=False, error=str(e))

    async def get_media(self, id: str) -> RouteResponse:
        """Get media resource by ID"""
        try:
            # result = await self.repository.read(id)
            result = {"id": id, "name": f"media_{id}"}
    ...
    async def update_media(self, id: str, data: Dict[str, Any]) -> RouteResponse:
        ...
        try:
            ...
            return RouteResponse(
                success=True,
                data=result,
                metadata={"endpoint": "update_media"}
            )
        except Exception as e:
            logger.error(f"Error updating media {id}: {e}")
            return RouteResponse(success=False, error=str(e))

    async def delete_media(self, id: str) -> RouteResponse:
        ...
        try:
            ...
            logger.error(f"Error deleting media {id}: {e}")
            return RouteResponse(success=False, error=str(e))

    async def search_media(self, query: Dict[str, Any]) -> RouteResponse:
    ...
    async def bulk_create_media(self, items: List[Dict[str, Any]]) -> RouteResponse:
        """Bulk create media resources"""
        try:
            created = []
            errors = []
            ...
            logger.error(f"Error bulk creating media: {e}")
            return RouteResponse(success=False, error=str(e))

    async def export_media(self, params: Dict[str, Any]) -> RouteResponse:
        """Export media data"""
        try:
    ...
    async def import_media(self, data: Dict[str, Any]) -> RouteResponse:
        """Import media data"""
        try:
    ...
    async def get_media_stats(self, params: Dict[str, Any] = None) -> RouteResponse:
...
class MediaRouter:
    ...
    def __init__(self):
        self.handler = MediaRouteHandler()
        self.routes = ROUTES
        self._middleware = []
    ...
    def get_openapi_spec(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "info": {
                "title": "Media API",
                "version": "1.0.0",
                "description": "API for media domain"
            },
            "paths": paths,
            "components": {
                "securitySchemes": {
