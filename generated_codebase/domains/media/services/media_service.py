...
class MediaAPIService(BaseMediaService):
    """REST API service for media"""
...
class MediaGRPCService(BaseMediaService):
    """gRPC service for media"""
...
class MediaWebSocketService(BaseMediaService):
    """WebSocket service for media"""
...
class MediaEventService(BaseMediaService):
    """Event-driven service for media"""
...
class MediaServiceRegistry:
    """Service registry for media"""

    _services: Dict[str, BaseMediaService] = {}

    @classmethod
    def register(cls, name: str, service: BaseMediaService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseMediaService]:
