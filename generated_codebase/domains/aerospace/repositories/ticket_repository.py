...
@dataclass
class AerospaceTicketEntity:
    """Entity for aerospace ticket"""
    id: str
    data: Dict[str, Any]
...
class AerospaceTicketInMemoryRepository(BaseAerospaceRepository[AerospaceTicketEntity]):
    """In-memory repository for aerospace ticket"""

    def __init__(self):
        self._storage: Dict[str, AerospaceTicketEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AerospaceTicketEntity) -> AerospaceTicketEntity:
    ...
    async def read(self, id: str) -> Optional[AerospaceTicketEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AerospaceTicketEntity) -> AerospaceTicketEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AerospaceTicketEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AerospaceTicketEntity]:
...
class AerospaceTicketCachedRepository(BaseAerospaceRepository[AerospaceTicketEntity]):
    """Cached repository wrapper for aerospace ticket"""
...
class AerospaceTicketUnitOfWork:
    """Unit of Work pattern for aerospace ticket"""

    def __init__(self, repository: BaseAerospaceRepository):
        self._repository = repository
        self._new: List[AerospaceTicketEntity] = []
        self._dirty: List[AerospaceTicketEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AerospaceTicketEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AerospaceTicketEntity) -> None:
