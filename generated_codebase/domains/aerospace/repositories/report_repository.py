...
@dataclass
class AerospaceReportEntity:
    """Entity for aerospace report"""
    id: str
    data: Dict[str, Any]
...
class AerospaceReportInMemoryRepository(BaseAerospaceRepository[AerospaceReportEntity]):
    """In-memory repository for aerospace report"""

    def __init__(self):
        self._storage: Dict[str, AerospaceReportEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AerospaceReportEntity) -> AerospaceReportEntity:
    ...
    async def read(self, id: str) -> Optional[AerospaceReportEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AerospaceReportEntity) -> AerospaceReportEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AerospaceReportEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AerospaceReportEntity]:
...
class AerospaceReportCachedRepository(BaseAerospaceRepository[AerospaceReportEntity]):
    """Cached repository wrapper for aerospace report"""
...
class AerospaceReportUnitOfWork:
    """Unit of Work pattern for aerospace report"""

    def __init__(self, repository: BaseAerospaceRepository):
        self._repository = repository
        self._new: List[AerospaceReportEntity] = []
        self._dirty: List[AerospaceReportEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AerospaceReportEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AerospaceReportEntity) -> None:
