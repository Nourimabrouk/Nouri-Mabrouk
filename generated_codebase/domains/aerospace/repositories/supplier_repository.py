...
@dataclass
class AerospaceSupplierEntity:
    """Entity for aerospace supplier"""
    id: str
    data: Dict[str, Any]
...
class AerospaceSupplierInMemoryRepository(BaseAerospaceRepository[AerospaceSupplierEntity]):
    """In-memory repository for aerospace supplier"""

    def __init__(self):
        self._storage: Dict[str, AerospaceSupplierEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: AerospaceSupplierEntity) -> AerospaceSupplierEntity:
    ...
    async def read(self, id: str) -> Optional[AerospaceSupplierEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: AerospaceSupplierEntity) -> AerospaceSupplierEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[AerospaceSupplierEntity]:
    ...
    async def find_by(self, **kwargs) -> List[AerospaceSupplierEntity]:
...
class AerospaceSupplierCachedRepository(BaseAerospaceRepository[AerospaceSupplierEntity]):
    """Cached repository wrapper for aerospace supplier"""
...
class AerospaceSupplierUnitOfWork:
    """Unit of Work pattern for aerospace supplier"""

    def __init__(self, repository: BaseAerospaceRepository):
        self._repository = repository
        self._new: List[AerospaceSupplierEntity] = []
        self._dirty: List[AerospaceSupplierEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: AerospaceSupplierEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: AerospaceSupplierEntity) -> None:
