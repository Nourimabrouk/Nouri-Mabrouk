"""
Healthcare Supplier Repository
...
@dataclass
class HealthcareSupplierEntity:
    """Entity for healthcare supplier"""
    id: str
    data: Dict[str, Any]
...
class HealthcareSupplierInMemoryRepository(BaseHealthcareRepository[HealthcareSupplierEntity]):
    """In-memory repository for healthcare supplier"""

    def __init__(self):
        self._storage: Dict[str, HealthcareSupplierEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HealthcareSupplierEntity) -> HealthcareSupplierEntity:
    ...
    async def read(self, id: str) -> Optional[HealthcareSupplierEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HealthcareSupplierEntity) -> HealthcareSupplierEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HealthcareSupplierEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HealthcareSupplierEntity]:
...
class HealthcareSupplierCachedRepository(BaseHealthcareRepository[HealthcareSupplierEntity]):
    """Cached repository wrapper for healthcare supplier"""
...
class HealthcareSupplierUnitOfWork:
    """Unit of Work pattern for healthcare supplier"""

    def __init__(self, repository: BaseHealthcareRepository):
        self._repository = repository
        self._new: List[HealthcareSupplierEntity] = []
        self._dirty: List[HealthcareSupplierEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HealthcareSupplierEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HealthcareSupplierEntity) -> None:
