...
@dataclass
class HealthcareInvoiceEntity:
    """Entity for healthcare invoice"""
    id: str
    data: Dict[str, Any]
...
class HealthcareInvoiceInMemoryRepository(BaseHealthcareRepository[HealthcareInvoiceEntity]):
    """In-memory repository for healthcare invoice"""

    def __init__(self):
        self._storage: Dict[str, HealthcareInvoiceEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HealthcareInvoiceEntity) -> HealthcareInvoiceEntity:
    ...
    async def read(self, id: str) -> Optional[HealthcareInvoiceEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HealthcareInvoiceEntity) -> HealthcareInvoiceEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HealthcareInvoiceEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HealthcareInvoiceEntity]:
...
class HealthcareInvoiceCachedRepository(BaseHealthcareRepository[HealthcareInvoiceEntity]):
    """Cached repository wrapper for healthcare invoice"""
...
class HealthcareInvoiceUnitOfWork:
    """Unit of Work pattern for healthcare invoice"""

    def __init__(self, repository: BaseHealthcareRepository):
        self._repository = repository
        self._new: List[HealthcareInvoiceEntity] = []
        self._dirty: List[HealthcareInvoiceEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HealthcareInvoiceEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HealthcareInvoiceEntity) -> None:
