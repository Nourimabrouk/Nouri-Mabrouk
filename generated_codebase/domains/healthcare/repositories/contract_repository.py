"""
Healthcare Contract Repository
...
@dataclass
class HealthcareContractEntity:
    """Entity for healthcare contract"""
    id: str
    data: Dict[str, Any]
...
class HealthcareContractInMemoryRepository(BaseHealthcareRepository[HealthcareContractEntity]):
    """In-memory repository for healthcare contract"""

    def __init__(self):
        self._storage: Dict[str, HealthcareContractEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HealthcareContractEntity) -> HealthcareContractEntity:
    ...
    async def read(self, id: str) -> Optional[HealthcareContractEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HealthcareContractEntity) -> HealthcareContractEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HealthcareContractEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HealthcareContractEntity]:
...
class HealthcareContractCachedRepository(BaseHealthcareRepository[HealthcareContractEntity]):
    """Cached repository wrapper for healthcare contract"""
...
class HealthcareContractUnitOfWork:
    """Unit of Work pattern for healthcare contract"""

    def __init__(self, repository: BaseHealthcareRepository):
        self._repository = repository
        self._new: List[HealthcareContractEntity] = []
        self._dirty: List[HealthcareContractEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HealthcareContractEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HealthcareContractEntity) -> None:
