...
@dataclass
class HealthcareTicketEntity:
    """Entity for healthcare ticket"""
    id: str
    data: Dict[str, Any]
...
class HealthcareTicketInMemoryRepository(BaseHealthcareRepository[HealthcareTicketEntity]):
    """In-memory repository for healthcare ticket"""

    def __init__(self):
        self._storage: Dict[str, HealthcareTicketEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HealthcareTicketEntity) -> HealthcareTicketEntity:
    ...
    async def read(self, id: str) -> Optional[HealthcareTicketEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HealthcareTicketEntity) -> HealthcareTicketEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HealthcareTicketEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HealthcareTicketEntity]:
...
class HealthcareTicketCachedRepository(BaseHealthcareRepository[HealthcareTicketEntity]):
    """Cached repository wrapper for healthcare ticket"""
...
class HealthcareTicketUnitOfWork:
    """Unit of Work pattern for healthcare ticket"""

    def __init__(self, repository: BaseHealthcareRepository):
        self._repository = repository
        self._new: List[HealthcareTicketEntity] = []
        self._dirty: List[HealthcareTicketEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HealthcareTicketEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HealthcareTicketEntity) -> None:
