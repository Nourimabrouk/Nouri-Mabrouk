...
@dataclass
class HealthcareReportEntity:
    """Entity for healthcare report"""
    id: str
    data: Dict[str, Any]
...
class HealthcareReportInMemoryRepository(BaseHealthcareRepository[HealthcareReportEntity]):
    """In-memory repository for healthcare report"""

    def __init__(self):
        self._storage: Dict[str, HealthcareReportEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HealthcareReportEntity) -> HealthcareReportEntity:
    ...
    async def read(self, id: str) -> Optional[HealthcareReportEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HealthcareReportEntity) -> HealthcareReportEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HealthcareReportEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HealthcareReportEntity]:
...
class HealthcareReportCachedRepository(BaseHealthcareRepository[HealthcareReportEntity]):
    """Cached repository wrapper for healthcare report"""
...
class HealthcareReportUnitOfWork:
    """Unit of Work pattern for healthcare report"""

    def __init__(self, repository: BaseHealthcareRepository):
        self._repository = repository
        self._new: List[HealthcareReportEntity] = []
        self._dirty: List[HealthcareReportEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HealthcareReportEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HealthcareReportEntity) -> None:
