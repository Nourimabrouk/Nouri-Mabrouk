"""
Healthcare Employee Repository
...
@dataclass
class HealthcareEmployeeEntity:
    """Entity for healthcare employee"""
    id: str
    data: Dict[str, Any]
...
class HealthcareEmployeeInMemoryRepository(BaseHealthcareRepository[HealthcareEmployeeEntity]):
    """In-memory repository for healthcare employee"""

    def __init__(self):
        self._storage: Dict[str, HealthcareEmployeeEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HealthcareEmployeeEntity) -> HealthcareEmployeeEntity:
    ...
    async def read(self, id: str) -> Optional[HealthcareEmployeeEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HealthcareEmployeeEntity) -> HealthcareEmployeeEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HealthcareEmployeeEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HealthcareEmployeeEntity]:
...
class HealthcareEmployeeCachedRepository(BaseHealthcareRepository[HealthcareEmployeeEntity]):
    """Cached repository wrapper for healthcare employee"""
...
class HealthcareEmployeeUnitOfWork:
    """Unit of Work pattern for healthcare employee"""

    def __init__(self, repository: BaseHealthcareRepository):
        self._repository = repository
        self._new: List[HealthcareEmployeeEntity] = []
        self._dirty: List[HealthcareEmployeeEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HealthcareEmployeeEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HealthcareEmployeeEntity) -> None:
