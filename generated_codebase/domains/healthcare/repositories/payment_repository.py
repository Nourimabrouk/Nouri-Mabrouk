...
@dataclass
class HealthcarePaymentEntity:
    """Entity for healthcare payment"""
    id: str
    data: Dict[str, Any]
...
class HealthcarePaymentInMemoryRepository(BaseHealthcareRepository[HealthcarePaymentEntity]):
    """In-memory repository for healthcare payment"""

    def __init__(self):
        self._storage: Dict[str, HealthcarePaymentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HealthcarePaymentEntity) -> HealthcarePaymentEntity:
    ...
    async def read(self, id: str) -> Optional[HealthcarePaymentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HealthcarePaymentEntity) -> HealthcarePaymentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HealthcarePaymentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HealthcarePaymentEntity]:
...
class HealthcarePaymentCachedRepository(BaseHealthcareRepository[HealthcarePaymentEntity]):
    """Cached repository wrapper for healthcare payment"""
...
class HealthcarePaymentUnitOfWork:
    """Unit of Work pattern for healthcare payment"""

    def __init__(self, repository: BaseHealthcareRepository):
        self._repository = repository
        self._new: List[HealthcarePaymentEntity] = []
        self._dirty: List[HealthcarePaymentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HealthcarePaymentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HealthcarePaymentEntity) -> None:
