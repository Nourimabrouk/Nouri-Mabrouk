"""
Healthcare Inventory Repository
...
@dataclass
class HealthcareInventoryEntity:
    """Entity for healthcare inventory"""
    id: str
    data: Dict[str, Any]
...
class HealthcareInventoryInMemoryRepository(BaseHealthcareRepository[HealthcareInventoryEntity]):
    """In-memory repository for healthcare inventory"""

    def __init__(self):
        self._storage: Dict[str, HealthcareInventoryEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HealthcareInventoryEntity) -> HealthcareInventoryEntity:
    ...
    async def read(self, id: str) -> Optional[HealthcareInventoryEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HealthcareInventoryEntity) -> HealthcareInventoryEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HealthcareInventoryEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HealthcareInventoryEntity]:
...
class HealthcareInventoryCachedRepository(BaseHealthcareRepository[HealthcareInventoryEntity]):
    """Cached repository wrapper for healthcare inventory"""
...
class HealthcareInventoryUnitOfWork:
    """Unit of Work pattern for healthcare inventory"""

    def __init__(self, repository: BaseHealthcareRepository):
        self._repository = repository
        self._new: List[HealthcareInventoryEntity] = []
        self._dirty: List[HealthcareInventoryEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HealthcareInventoryEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HealthcareInventoryEntity) -> None:
