"""
Healthcare Shipment Repository
...
@dataclass
class HealthcareShipmentEntity:
    """Entity for healthcare shipment"""
    id: str
    data: Dict[str, Any]
...
class HealthcareShipmentInMemoryRepository(BaseHealthcareRepository[HealthcareShipmentEntity]):
    """In-memory repository for healthcare shipment"""

    def __init__(self):
        self._storage: Dict[str, HealthcareShipmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HealthcareShipmentEntity) -> HealthcareShipmentEntity:
    ...
    async def read(self, id: str) -> Optional[HealthcareShipmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HealthcareShipmentEntity) -> HealthcareShipmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HealthcareShipmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HealthcareShipmentEntity]:
...
class HealthcareShipmentCachedRepository(BaseHealthcareRepository[HealthcareShipmentEntity]):
    """Cached repository wrapper for healthcare shipment"""
...
class HealthcareShipmentUnitOfWork:
    """Unit of Work pattern for healthcare shipment"""

    def __init__(self, repository: BaseHealthcareRepository):
        self._repository = repository
        self._new: List[HealthcareShipmentEntity] = []
        self._dirty: List[HealthcareShipmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HealthcareShipmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HealthcareShipmentEntity) -> None:
