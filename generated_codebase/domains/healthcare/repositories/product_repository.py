...
@dataclass
class HealthcareProductEntity:
    """Entity for healthcare product"""
    id: str
    data: Dict[str, Any]
...
class HealthcareProductInMemoryRepository(BaseHealthcareRepository[HealthcareProductEntity]):
    """In-memory repository for healthcare product"""

    def __init__(self):
        self._storage: Dict[str, HealthcareProductEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: HealthcareProductEntity) -> HealthcareProductEntity:
    ...
    async def read(self, id: str) -> Optional[HealthcareProductEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: HealthcareProductEntity) -> HealthcareProductEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[HealthcareProductEntity]:
    ...
    async def find_by(self, **kwargs) -> List[HealthcareProductEntity]:
...
class HealthcareProductCachedRepository(BaseHealthcareRepository[HealthcareProductEntity]):
    """Cached repository wrapper for healthcare product"""
...
class HealthcareProductUnitOfWork:
    """Unit of Work pattern for healthcare product"""

    def __init__(self, repository: BaseHealthcareRepository):
        self._repository = repository
        self._new: List[HealthcareProductEntity] = []
        self._dirty: List[HealthcareProductEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: HealthcareProductEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: HealthcareProductEntity) -> None:
