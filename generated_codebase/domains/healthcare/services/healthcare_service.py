...
class BaseHealthcareService(ABC):
    """Base service class for healthcare"""
...
class HealthcareAPIService(BaseHealthcareService):
    """REST API service for healthcare"""
...
class HealthcareGRPCService(BaseHealthcareService):
    """gRPC service for healthcare"""
...
class HealthcareWebSocketService(BaseHealthcareService):
...
class HealthcareEventService(BaseHealthcareService):
    """Event-driven service for healthcare"""
...
class HealthcareServiceRegistry:
    """Service registry for healthcare"""

    _services: Dict[str, BaseHealthcareService] = {}

    @classmethod
    def register(cls, name: str, service: BaseHealthcareService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseHealthcareService]:
