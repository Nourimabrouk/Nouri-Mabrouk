"""
Cybersecurity Supplier Repository
...
@dataclass
class CybersecuritySupplierEntity:
    """Entity for cybersecurity supplier"""
    id: str
    data: Dict[str, Any]
...
class CybersecuritySupplierInMemoryRepository(BaseCybersecurityRepository[CybersecuritySupplierEntity]):
    """In-memory repository for cybersecurity supplier"""

    def __init__(self):
        self._storage: Dict[str, CybersecuritySupplierEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: CybersecuritySupplierEntity) -> CybersecuritySupplierEntity:
    ...
    async def read(self, id: str) -> Optional[CybersecuritySupplierEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: CybersecuritySupplierEntity) -> CybersecuritySupplierEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[CybersecuritySupplierEntity]:
    ...
    async def find_by(self, **kwargs) -> List[CybersecuritySupplierEntity]:
...
class CybersecuritySupplierCachedRepository(BaseCybersecurityRepository[CybersecuritySupplierEntity]):
    """Cached repository wrapper for cybersecurity supplier"""
...
class CybersecuritySupplierUnitOfWork:
    """Unit of Work pattern for cybersecurity supplier"""

    def __init__(self, repository: BaseCybersecurityRepository):
        self._repository = repository
        self._new: List[CybersecuritySupplierEntity] = []
        self._dirty: List[CybersecuritySupplierEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: CybersecuritySupplierEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: CybersecuritySupplierEntity) -> None:
