"""
Cybersecurity Product Repository
...
@dataclass
class CybersecurityProductEntity:
    """Entity for cybersecurity product"""
    id: str
    data: Dict[str, Any]
...
class CybersecurityProductInMemoryRepository(BaseCybersecurityRepository[CybersecurityProductEntity]):
    """In-memory repository for cybersecurity product"""

    def __init__(self):
        self._storage: Dict[str, CybersecurityProductEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: CybersecurityProductEntity) -> CybersecurityProductEntity:
    ...
    async def read(self, id: str) -> Optional[CybersecurityProductEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: CybersecurityProductEntity) -> CybersecurityProductEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[CybersecurityProductEntity]:
    ...
    async def find_by(self, **kwargs) -> List[CybersecurityProductEntity]:
...
class CybersecurityProductCachedRepository(BaseCybersecurityRepository[CybersecurityProductEntity]):
    """Cached repository wrapper for cybersecurity product"""
...
class CybersecurityProductUnitOfWork:
    """Unit of Work pattern for cybersecurity product"""

    def __init__(self, repository: BaseCybersecurityRepository):
        self._repository = repository
        self._new: List[CybersecurityProductEntity] = []
        self._dirty: List[CybersecurityProductEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: CybersecurityProductEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: CybersecurityProductEntity) -> None:
