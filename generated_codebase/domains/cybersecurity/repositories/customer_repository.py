"""
Cybersecurity Customer Repository
...
@dataclass
class CybersecurityCustomerEntity:
    """Entity for cybersecurity customer"""
    id: str
    data: Dict[str, Any]
...
class CybersecurityCustomerInMemoryRepository(BaseCybersecurityRepository[CybersecurityCustomerEntity]):
    """In-memory repository for cybersecurity customer"""

    def __init__(self):
        self._storage: Dict[str, CybersecurityCustomerEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: CybersecurityCustomerEntity) -> CybersecurityCustomerEntity:
    ...
    async def read(self, id: str) -> Optional[CybersecurityCustomerEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: CybersecurityCustomerEntity) -> CybersecurityCustomerEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[CybersecurityCustomerEntity]:
    ...
    async def find_by(self, **kwargs) -> List[CybersecurityCustomerEntity]:
...
class CybersecurityCustomerCachedRepository(BaseCybersecurityRepository[CybersecurityCustomerEntity]):
    """Cached repository wrapper for cybersecurity customer"""
...
class CybersecurityCustomerUnitOfWork:
    """Unit of Work pattern for cybersecurity customer"""

    def __init__(self, repository: BaseCybersecurityRepository):
        self._repository = repository
        self._new: List[CybersecurityCustomerEntity] = []
        self._dirty: List[CybersecurityCustomerEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: CybersecurityCustomerEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: CybersecurityCustomerEntity) -> None:
