"""
Cybersecurity Shipment Repository
...
@dataclass
class CybersecurityShipmentEntity:
    """Entity for cybersecurity shipment"""
    id: str
    data: Dict[str, Any]
...
class CybersecurityShipmentInMemoryRepository(BaseCybersecurityRepository[CybersecurityShipmentEntity]):
    """In-memory repository for cybersecurity shipment"""

    def __init__(self):
        self._storage: Dict[str, CybersecurityShipmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: CybersecurityShipmentEntity) -> CybersecurityShipmentEntity:
    ...
    async def read(self, id: str) -> Optional[CybersecurityShipmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: CybersecurityShipmentEntity) -> CybersecurityShipmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[CybersecurityShipmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[CybersecurityShipmentEntity]:
...
class CybersecurityShipmentCachedRepository(BaseCybersecurityRepository[CybersecurityShipmentEntity]):
    """Cached repository wrapper for cybersecurity shipment"""
...
class CybersecurityShipmentUnitOfWork:
    """Unit of Work pattern for cybersecurity shipment"""

    def __init__(self, repository: BaseCybersecurityRepository):
        self._repository = repository
        self._new: List[CybersecurityShipmentEntity] = []
        self._dirty: List[CybersecurityShipmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: CybersecurityShipmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: CybersecurityShipmentEntity) -> None:
