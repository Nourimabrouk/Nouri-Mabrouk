...
# Route definitions for government domain
ROUTES = {
    "base_path": "/api/v1/government",
    "endpoints": [
        {
            "path": "/",
            "method": "GET",
            "handler": "list_government",
            "description": "List all government resources",
            "auth_required": True,
            "rate_limit": 100
        },
        {
        ...
        },
        {
            "path": "/{id}",
            "method": "GET",
            "handler": "get_government",
            "description": "Get government resource by ID",
            "auth_required": True,
            "rate_limit": 200
        },
        {
        ...
        },
        {
            "path": "/search",
            "method": "POST",
            "handler": "search_government",
            "description": "Search government resources",
            "auth_required": True,
            "rate_limit": 100
        },
        {
            "path": "/bulk",
            "method": "POST",
            "handler": "bulk_create_government",
            "description": "Bulk create government resources",
            "auth_required": True,
            "rate_limit": 10
        },
        {
            "path": "/export",
            "method": "GET",
            "handler": "export_government",
            "description": "Export government data",
            "auth_required": True,
            "rate_limit": 5
        },
        {
            "path": "/import",
            "method": "POST",
            "handler": "import_government",
            "description": "Import government data",
            "auth_required": True,
            "rate_limit": 5
        },
        {
            "path": "/stats",
            "method": "GET",
            "handler": "get_government_stats",
            "description": "Get government statistics",
            "auth_required": True,
            "rate_limit": 50
        }
    ]
...
class GovernmentRouteHandler:
    """Route handler for government"""
    ...
    async def list_government(self, params: Dict[str, Any]) -> RouteResponse:
        """List government resources"""
        try:
            ...
            return RouteResponse(
                ...
                metadata={"endpoint": "list_government"}
            )
        except Exception as e:
            logger.error(f"Error listing government: {e}")
            return RouteResponse(success=False, error=str(e))

    async def create_government(self, data: Dict[str, Any]) -> RouteResponse:
        """Create government resource"""
        try:
            # Validate and create
            ...
            return RouteResponse(
                success=True,
                data=result,
                metadata={"endpoint": "create_government"}
            )
        except Exception as e:
            logger.error(f"Error creating government: {e}")
            return RouteResponse(success=False, error=str(e))

    async def get_government(self, id: str) -> RouteResponse:
        """Get government resource by ID"""
        try:
            # result = await self.repository.read(id)
            result = {"id": id, "name": f"government_{id}"}
            ...
            logger.error(f"Error getting government {id}: {e}")
            return RouteResponse(success=False, error=str(e))

    async def update_government(self, id: str, data: Dict[str, Any]) -> RouteResponse:
        """Update government resource"""
        try:
            ...
            return RouteResponse(
                success=True,
                data=result,
                metadata={"endpoint": "update_government"}
            )
        except Exception as e:
            logger.error(f"Error updating government {id}: {e}")
            return RouteResponse(success=False, error=str(e))

    async def delete_government(self, id: str) -> RouteResponse:
        """Delete government resource"""
        try:
            ...
            logger.error(f"Error deleting government {id}: {e}")
            return RouteResponse(success=False, error=str(e))

    async def search_government(self, query: Dict[str, Any]) -> RouteResponse:
        ...
        try:
            ...
            logger.error(f"Error searching government: {e}")
            return RouteResponse(success=False, error=str(e))

    async def bulk_create_government(self, items: List[Dict[str, Any]]) -> RouteResponse:
        """Bulk create government resources"""
        try:
            created = []
            errors = []
            ...
            logger.error(f"Error bulk creating government: {e}")
            return RouteResponse(success=False, error=str(e))

    async def export_government(self, params: Dict[str, Any]) -> RouteResponse:
        ...
        try:
            ...
            logger.error(f"Error exporting government: {e}")
            return RouteResponse(success=False, error=str(e))

    async def import_government(self, data: Dict[str, Any]) -> RouteResponse:
        ...
        try:
            ...
            logger.error(f"Error importing government: {e}")
            return RouteResponse(success=False, error=str(e))

    async def get_government_stats(self, params: Dict[str, Any] = None) -> RouteResponse:
...
class GovernmentRouter:
    """Router for government endpoints"""

    def __init__(self):
        self.handler = GovernmentRouteHandler()
        self.routes = ROUTES
        self._middleware = []
    ...
    def get_openapi_spec(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "info": {
                ...
                "version": "1.0.0",
                "description": "API for government domain"
            },
            "paths": paths,
            "components": {
                "securitySchemes": {
