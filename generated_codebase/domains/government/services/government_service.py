...
class BaseGovernmentService(ABC):
    """Base service class for government"""
...
class GovernmentAPIService(BaseGovernmentService):
    """REST API service for government"""
...
class GovernmentGRPCService(BaseGovernmentService):
    """gRPC service for government"""
...
class GovernmentWebSocketService(BaseGovernmentService):
    """WebSocket service for government"""
...
class GovernmentEventService(BaseGovernmentService):
    """Event-driven service for government"""
...
class GovernmentServiceRegistry:
    """Service registry for government"""

    _services: Dict[str, BaseGovernmentService] = {}

    @classmethod
    def register(cls, name: str, service: BaseGovernmentService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseGovernmentService]:
