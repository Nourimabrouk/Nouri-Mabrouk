...
class BasePharmaService(ABC):
    """Base service class for pharma"""
...
class PharmaAPIService(BasePharmaService):
    """REST API service for pharma"""
...
class PharmaGRPCService(BasePharmaService):
    """gRPC service for pharma"""
...
class PharmaWebSocketService(BasePharmaService):
    """WebSocket service for pharma"""
...
class PharmaEventService(BasePharmaService):
    """Event-driven service for pharma"""
...
class PharmaServiceRegistry:
    """Service registry for pharma"""

    _services: Dict[str, BasePharmaService] = {}

    @classmethod
    def register(cls, name: str, service: BasePharmaService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BasePharmaService]:
