...
@dataclass
class PharmaAppointmentEntity:
    """Entity for pharma appointment"""
    id: str
    data: Dict[str, Any]
...
class PharmaAppointmentInMemoryRepository(BasePharmaRepository[PharmaAppointmentEntity]):
    """In-memory repository for pharma appointment"""

    def __init__(self):
        self._storage: Dict[str, PharmaAppointmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: PharmaAppointmentEntity) -> PharmaAppointmentEntity:
    ...
    async def read(self, id: str) -> Optional[PharmaAppointmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: PharmaAppointmentEntity) -> PharmaAppointmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[PharmaAppointmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[PharmaAppointmentEntity]:
...
class PharmaAppointmentCachedRepository(BasePharmaRepository[PharmaAppointmentEntity]):
    """Cached repository wrapper for pharma appointment"""
...
class PharmaAppointmentUnitOfWork:
    """Unit of Work pattern for pharma appointment"""

    def __init__(self, repository: BasePharmaRepository):
        self._repository = repository
        self._new: List[PharmaAppointmentEntity] = []
        self._dirty: List[PharmaAppointmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: PharmaAppointmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: PharmaAppointmentEntity) -> None:
