...
@dataclass
class PharmaAssessmentEntity:
    """Entity for pharma assessment"""
    id: str
    data: Dict[str, Any]
...
class PharmaAssessmentInMemoryRepository(BasePharmaRepository[PharmaAssessmentEntity]):
    """In-memory repository for pharma assessment"""

    def __init__(self):
        self._storage: Dict[str, PharmaAssessmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: PharmaAssessmentEntity) -> PharmaAssessmentEntity:
    ...
    async def read(self, id: str) -> Optional[PharmaAssessmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: PharmaAssessmentEntity) -> PharmaAssessmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[PharmaAssessmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[PharmaAssessmentEntity]:
...
class PharmaAssessmentCachedRepository(BasePharmaRepository[PharmaAssessmentEntity]):
    """Cached repository wrapper for pharma assessment"""
...
class PharmaAssessmentUnitOfWork:
    """Unit of Work pattern for pharma assessment"""

    def __init__(self, repository: BasePharmaRepository):
        self._repository = repository
        self._new: List[PharmaAssessmentEntity] = []
        self._dirty: List[PharmaAssessmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: PharmaAssessmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: PharmaAssessmentEntity) -> None:
