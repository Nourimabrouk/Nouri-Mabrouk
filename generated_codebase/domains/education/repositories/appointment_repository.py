"""
Education Appointment Repository
...
@dataclass
class EducationAppointmentEntity:
    """Entity for education appointment"""
    id: str
    data: Dict[str, Any]
...
class EducationAppointmentInMemoryRepository(BaseEducationRepository[EducationAppointmentEntity]):
    """In-memory repository for education appointment"""

    def __init__(self):
        self._storage: Dict[str, EducationAppointmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: EducationAppointmentEntity) -> EducationAppointmentEntity:
    ...
    async def read(self, id: str) -> Optional[EducationAppointmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: EducationAppointmentEntity) -> EducationAppointmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[EducationAppointmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[EducationAppointmentEntity]:
...
class EducationAppointmentCachedRepository(BaseEducationRepository[EducationAppointmentEntity]):
    """Cached repository wrapper for education appointment"""
...
class EducationAppointmentUnitOfWork:
    """Unit of Work pattern for education appointment"""

    def __init__(self, repository: BaseEducationRepository):
        self._repository = repository
        self._new: List[EducationAppointmentEntity] = []
        self._dirty: List[EducationAppointmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: EducationAppointmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: EducationAppointmentEntity) -> None:
