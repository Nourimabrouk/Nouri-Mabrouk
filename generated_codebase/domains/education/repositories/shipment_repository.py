...
@dataclass
class EducationShipmentEntity:
    """Entity for education shipment"""
    id: str
    data: Dict[str, Any]
...
class EducationShipmentInMemoryRepository(BaseEducationRepository[EducationShipmentEntity]):
    """In-memory repository for education shipment"""

    def __init__(self):
        self._storage: Dict[str, EducationShipmentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: EducationShipmentEntity) -> EducationShipmentEntity:
    ...
    async def read(self, id: str) -> Optional[EducationShipmentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: EducationShipmentEntity) -> EducationShipmentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[EducationShipmentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[EducationShipmentEntity]:
...
class EducationShipmentCachedRepository(BaseEducationRepository[EducationShipmentEntity]):
    """Cached repository wrapper for education shipment"""
...
class EducationShipmentUnitOfWork:
    """Unit of Work pattern for education shipment"""

    def __init__(self, repository: BaseEducationRepository):
        self._repository = repository
        self._new: List[EducationShipmentEntity] = []
        self._dirty: List[EducationShipmentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: EducationShipmentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: EducationShipmentEntity) -> None:
