...
@dataclass
class EducationSupplierEntity:
    """Entity for education supplier"""
    id: str
    data: Dict[str, Any]
...
class EducationSupplierInMemoryRepository(BaseEducationRepository[EducationSupplierEntity]):
    """In-memory repository for education supplier"""

    def __init__(self):
        self._storage: Dict[str, EducationSupplierEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: EducationSupplierEntity) -> EducationSupplierEntity:
    ...
    async def read(self, id: str) -> Optional[EducationSupplierEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: EducationSupplierEntity) -> EducationSupplierEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[EducationSupplierEntity]:
    ...
    async def find_by(self, **kwargs) -> List[EducationSupplierEntity]:
...
class EducationSupplierCachedRepository(BaseEducationRepository[EducationSupplierEntity]):
    """Cached repository wrapper for education supplier"""
...
class EducationSupplierUnitOfWork:
    """Unit of Work pattern for education supplier"""

    def __init__(self, repository: BaseEducationRepository):
        self._repository = repository
        self._new: List[EducationSupplierEntity] = []
        self._dirty: List[EducationSupplierEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: EducationSupplierEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: EducationSupplierEntity) -> None:
