...
@dataclass
class EducationEmployeeEntity:
    """Entity for education employee"""
    id: str
    data: Dict[str, Any]
...
class EducationEmployeeInMemoryRepository(BaseEducationRepository[EducationEmployeeEntity]):
    """In-memory repository for education employee"""

    def __init__(self):
        self._storage: Dict[str, EducationEmployeeEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: EducationEmployeeEntity) -> EducationEmployeeEntity:
    ...
    async def read(self, id: str) -> Optional[EducationEmployeeEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: EducationEmployeeEntity) -> EducationEmployeeEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[EducationEmployeeEntity]:
    ...
    async def find_by(self, **kwargs) -> List[EducationEmployeeEntity]:
...
class EducationEmployeeCachedRepository(BaseEducationRepository[EducationEmployeeEntity]):
    """Cached repository wrapper for education employee"""
...
class EducationEmployeeUnitOfWork:
    """Unit of Work pattern for education employee"""

    def __init__(self, repository: BaseEducationRepository):
        self._repository = repository
        self._new: List[EducationEmployeeEntity] = []
        self._dirty: List[EducationEmployeeEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: EducationEmployeeEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: EducationEmployeeEntity) -> None:
