...
@dataclass
class EducationPaymentEntity:
    """Entity for education payment"""
    id: str
    data: Dict[str, Any]
...
class EducationPaymentInMemoryRepository(BaseEducationRepository[EducationPaymentEntity]):
    """In-memory repository for education payment"""

    def __init__(self):
        self._storage: Dict[str, EducationPaymentEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: EducationPaymentEntity) -> EducationPaymentEntity:
    ...
    async def read(self, id: str) -> Optional[EducationPaymentEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: EducationPaymentEntity) -> EducationPaymentEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[EducationPaymentEntity]:
    ...
    async def find_by(self, **kwargs) -> List[EducationPaymentEntity]:
...
class EducationPaymentCachedRepository(BaseEducationRepository[EducationPaymentEntity]):
    """Cached repository wrapper for education payment"""
...
class EducationPaymentUnitOfWork:
    """Unit of Work pattern for education payment"""

    def __init__(self, repository: BaseEducationRepository):
        self._repository = repository
        self._new: List[EducationPaymentEntity] = []
        self._dirty: List[EducationPaymentEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: EducationPaymentEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: EducationPaymentEntity) -> None:
