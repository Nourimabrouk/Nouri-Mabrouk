...
@dataclass
class EducationReportEntity:
    """Entity for education report"""
    id: str
    data: Dict[str, Any]
...
class EducationReportInMemoryRepository(BaseEducationRepository[EducationReportEntity]):
    """In-memory repository for education report"""

    def __init__(self):
        self._storage: Dict[str, EducationReportEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: EducationReportEntity) -> EducationReportEntity:
    ...
    async def read(self, id: str) -> Optional[EducationReportEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: EducationReportEntity) -> EducationReportEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[EducationReportEntity]:
    ...
    async def find_by(self, **kwargs) -> List[EducationReportEntity]:
...
class EducationReportCachedRepository(BaseEducationRepository[EducationReportEntity]):
    """Cached repository wrapper for education report"""
...
class EducationReportUnitOfWork:
    """Unit of Work pattern for education report"""

    def __init__(self, repository: BaseEducationRepository):
        self._repository = repository
        self._new: List[EducationReportEntity] = []
        self._dirty: List[EducationReportEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: EducationReportEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: EducationReportEntity) -> None:
