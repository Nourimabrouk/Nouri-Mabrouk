"""
Education Inventory Repository
...
@dataclass
class EducationInventoryEntity:
    """Entity for education inventory"""
    id: str
    data: Dict[str, Any]
...
class EducationInventoryInMemoryRepository(BaseEducationRepository[EducationInventoryEntity]):
    """In-memory repository for education inventory"""

    def __init__(self):
        self._storage: Dict[str, EducationInventoryEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: EducationInventoryEntity) -> EducationInventoryEntity:
    ...
    async def read(self, id: str) -> Optional[EducationInventoryEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: EducationInventoryEntity) -> EducationInventoryEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[EducationInventoryEntity]:
    ...
    async def find_by(self, **kwargs) -> List[EducationInventoryEntity]:
...
class EducationInventoryCachedRepository(BaseEducationRepository[EducationInventoryEntity]):
    """Cached repository wrapper for education inventory"""
...
class EducationInventoryUnitOfWork:
    """Unit of Work pattern for education inventory"""

    def __init__(self, repository: BaseEducationRepository):
        self._repository = repository
        self._new: List[EducationInventoryEntity] = []
        self._dirty: List[EducationInventoryEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: EducationInventoryEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: EducationInventoryEntity) -> None:
