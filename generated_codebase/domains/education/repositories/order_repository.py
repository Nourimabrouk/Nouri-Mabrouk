...
@dataclass
class EducationOrderEntity:
    """Entity for education order"""
    id: str
    data: Dict[str, Any]
...
class EducationOrderInMemoryRepository(BaseEducationRepository[EducationOrderEntity]):
    """In-memory repository for education order"""

    def __init__(self):
        self._storage: Dict[str, EducationOrderEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: EducationOrderEntity) -> EducationOrderEntity:
    ...
    async def read(self, id: str) -> Optional[EducationOrderEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: EducationOrderEntity) -> EducationOrderEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[EducationOrderEntity]:
    ...
    async def find_by(self, **kwargs) -> List[EducationOrderEntity]:
...
class EducationOrderCachedRepository(BaseEducationRepository[EducationOrderEntity]):
    """Cached repository wrapper for education order"""
...
class EducationOrderUnitOfWork:
    """Unit of Work pattern for education order"""

    def __init__(self, repository: BaseEducationRepository):
        self._repository = repository
        self._new: List[EducationOrderEntity] = []
        self._dirty: List[EducationOrderEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: EducationOrderEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: EducationOrderEntity) -> None:
