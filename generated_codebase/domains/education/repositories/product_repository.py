...
@dataclass
class EducationProductEntity:
    """Entity for education product"""
    id: str
    data: Dict[str, Any]
...
class EducationProductInMemoryRepository(BaseEducationRepository[EducationProductEntity]):
    """In-memory repository for education product"""

    def __init__(self):
        self._storage: Dict[str, EducationProductEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: EducationProductEntity) -> EducationProductEntity:
    ...
    async def read(self, id: str) -> Optional[EducationProductEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: EducationProductEntity) -> EducationProductEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[EducationProductEntity]:
    ...
    async def find_by(self, **kwargs) -> List[EducationProductEntity]:
...
class EducationProductCachedRepository(BaseEducationRepository[EducationProductEntity]):
    """Cached repository wrapper for education product"""
...
class EducationProductUnitOfWork:
    """Unit of Work pattern for education product"""

    def __init__(self, repository: BaseEducationRepository):
        self._repository = repository
        self._new: List[EducationProductEntity] = []
        self._dirty: List[EducationProductEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: EducationProductEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: EducationProductEntity) -> None:
