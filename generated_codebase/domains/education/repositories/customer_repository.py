...
@dataclass
class EducationCustomerEntity:
    """Entity for education customer"""
    id: str
    data: Dict[str, Any]
...
class EducationCustomerInMemoryRepository(BaseEducationRepository[EducationCustomerEntity]):
    """In-memory repository for education customer"""

    def __init__(self):
        self._storage: Dict[str, EducationCustomerEntity] = {}
        self._lock = asyncio.Lock()

    async def create(self, entity: EducationCustomerEntity) -> EducationCustomerEntity:
    ...
    async def read(self, id: str) -> Optional[EducationCustomerEntity]:
        entity = self._storage.get(id)
        if entity and not entity.is_deleted:
            return entity
        return None

    async def update(self, entity: EducationCustomerEntity) -> EducationCustomerEntity:
        async with self._lock:
    ...
    async def list(self, filters: Dict[str, Any] = None, limit: int = 100, offset: int = 0) -> List[EducationCustomerEntity]:
    ...
    async def find_by(self, **kwargs) -> List[EducationCustomerEntity]:
...
class EducationCustomerCachedRepository(BaseEducationRepository[EducationCustomerEntity]):
    """Cached repository wrapper for education customer"""
...
class EducationCustomerUnitOfWork:
    """Unit of Work pattern for education customer"""

    def __init__(self, repository: BaseEducationRepository):
        self._repository = repository
        self._new: List[EducationCustomerEntity] = []
        self._dirty: List[EducationCustomerEntity] = []
        self._deleted: List[str] = []

    def register_new(self, entity: EducationCustomerEntity) -> None:
        self._new.append(entity)

    def register_dirty(self, entity: EducationCustomerEntity) -> None:
