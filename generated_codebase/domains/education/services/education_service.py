...
class BaseEducationService(ABC):
    """Base service class for education"""
...
class EducationAPIService(BaseEducationService):
...
class EducationGRPCService(BaseEducationService):
    """gRPC service for education"""
...
class EducationWebSocketService(BaseEducationService):
    """WebSocket service for education"""
...
class EducationEventService(BaseEducationService):
    """Event-driven service for education"""
...
class EducationServiceRegistry:
    """Service registry for education"""

    _services: Dict[str, BaseEducationService] = {}

    @classmethod
    def register(cls, name: str, service: BaseEducationService) -> None:
        cls._services[name] = service

    @classmethod
    def get(cls, name: str) -> Optional[BaseEducationService]:
